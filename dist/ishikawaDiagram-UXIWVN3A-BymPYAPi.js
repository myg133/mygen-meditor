import { _ as o, c as ot, N as ut, I as dt, as as yt, z as ft, k as pt, p as it, a as gt, b as kt, g as wt, s as mt, q as _t, e as bt } from "./index-DWbaqf43.js";
var tt = function() {
  var e = /* @__PURE__ */ o(function(M, t, s, i) {
    ...
    parse: /* @__PURE__ */ o(function(t) {
      ...
      for (var z in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, z) && (C.yy[z] = this.yy[z]);
      ...
      for (var A, W, P, K, H = {}, X, V, et, Y; ; ) {
        if (W = i[i.length - 1], this.defaultActions[W] ? P = this.defaultActions[W] : ((A === null || typeof A > "u") && (A = j()), P = v[W] && v[W][A]), typeof P > "u" || !P.length || !P[0]) {
          var Q = "";
          Y = [];
          for (X in v[W])
...
var xt = tt, Z, vt = (Z = class {
  ...
  if (!y)
    return;
  const f = ot(), { look: d, handDrawnSeed: w, themeVariables: c } = f, k = ut(f.fontSize)[0] ?? St, g = d === "handDrawn", _ = y.children ?? [], x = ((C = f.ishikawa) == null ? void 0 : C.diagramPadding) ?? 20, B = ((z = f.ishikawa) == null ? void 0 : z.useMaxWidth) ?? !1, O = dt(h), $ = O.append("g").attr("class", "ishikawa"), M = g ? yt.svg(O.node()) : void 0, t = M ? {
    roughSvg: M,
    seed: w ?? 0,
  ...
  for (let T = 0; T < b; T++) {
    ...
    for (const [F, j, A] of [
      ...
      F && Nt(D, F, i, u, j, A, k, t);
    i = D.selectAll("text").nodes().reduce((F, j) => Math.min(F, j.getBBox().x), 1 / 0);
  }
  if (g)
