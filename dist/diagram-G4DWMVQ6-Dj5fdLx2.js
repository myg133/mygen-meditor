import { _ as w, K as he, D as ee, F as J, I as ue, e as pe, l as Q, bd as P, d as j, b as fe, a as ge, p as me, q as ye, g as Se, s as ve, G as xe, be, z as we } from "./index-DWbaqf43.js";
import { s as Ce } from "./chunk-EDXVE4YY-DGDd9cTi.js";
import { p as Te } from "./chunk-4BX2VUAB-Z2iPX9wy.js";
import { p as Le } from "./wardley-RL74JXVD-DrWbK5uC.js";
...
function te(t, a) {
  ...
  for (var l = new K(t), n, r = [l], s, d, h, g; n = r.pop(); )
    if ((d = a(n.data)) && (g = (d = Array.from(d)).length))
      for (n.children = d, h = g - 1; h >= 0; --h)
        r.push(s = d[h] = new K(d[h])), s.parent = n, s.depth = n.depth + 1;
...
function Ze(t, a, l, n, r, s) {
  for (var d = [], h = a.children, g, c, u = 0, b = 0, i = h.length, x, S, v = a.value, p, m, M, N, z, E, V; u < i; ) {
    ...
    for (m = M = p, E = Math.max(S / x, x / S) / (v * t), V = p * p * E, z = Math.max(M / V, V / m); b < i; ++b) {
      if (p += c = h[b].value, c < m && (m = c), c > M && (M = c), V = p * p * E, N = Math.max(M / V, V / m), N > z) {
        p -= c;
        break;
      }
      z = N;
    }
    d.push(g = { value: p, dice: x < S, children: h.slice(u, b) }), g.dice ? je(g, l, n, r, v ? n += S * p / v : s) : Ke(g, l, n, v ? l += x * p / v : r, s), v -= p, u = b;
  }
  return d;
}
...
function Qe() {
  var t = Je, a = !1, l = 1, n = 1, r = [0], s = G, d = G, h = G, g = G, c = G;
  function u(i) {
    return i.x0 = i.y0 = 0, i.x1 = l, i.y1 = n, i.eachBefore(b), r = [0], a && i.eachBefore(Ye), i;
  }
  function b(i) {
    var x = r[i.depth], S = i.x0 + x, v = i.y0 + x, p = i.x1 - x, m = i.y1 - x;
    p < S && (S = p = (S + p) / 2), m < v && (v = m = (v + m) / 2), i.x0 = S, i.y0 = v, i.x1 = p, i.y1 = m, i.children && (x = r[i.depth + 1] = s(i) / 2, S += c(i) - x, v += d(i) - x, p -= h(i) - x, m -= g(i) - x, p < S && (S = p = (S + p) / 2), m < v && (v = m = (v + m) / 2), t(i, S, v, p, m));
  }
  return u.round = function(i) {
    ...
    return arguments.length ? (s = typeof i == "function" ? i : q(+i), u) : s;
    ...
    return arguments.length ? (d = typeof i == "function" ? i : q(+i), u) : d;
  }, u.paddingRight = function(i) {
    return arguments.length ? (h = typeof i == "function" ? i : q(+i), u) : h;
  }, u.paddingBottom = function(i) {
    return arguments.length ? (g = typeof i == "function" ? i : q(+i), u) : g;
  }, u.paddingLeft = function(i) {
    return arguments.length ? (c = typeof i == "function" ? i : q(+i), u) : c;
  }, u;
}
var R, ne = (R = class {
  constructor() {
...
function le(t) {
  ...
  return t.forEach((n) => {
    ...
    for (r.classSelector = n == null ? void 0 : n.classSelector, n != null && n.cssCompiledStyles && (r.cssCompiledStyles = n.cssCompiledStyles), n.type === "Leaf" && n.value !== void 0 && (r.value = n.value); l.length > 0 && l[l.length - 1].level >= n.level; )
      l.pop();
    if (l.length === 0)
      a.push(r);
    else {
...
var et = /* @__PURE__ */ w((t, a) => {
  ...
  for (const s of t.TreemapRows ?? []) {
    ...
    if (!d)
      continue;
    const h = s.indent ? parseInt(s.indent) : 0, g = tt(d), c = d.classSelector ? a.getStylesForClass(d.classSelector) : [], u = c.length > 0 ? c : void 0, b = {
      level: h,
      name: g,
      type: d.$type,
      value: d.value,
  ...
  const r = n.db, s = r.getConfig(), d = s.padding ?? at, h = r.getDiagramTitle(), g = r.getRoot(), { themeVariables: c } = ee();
  if (!g)
    return;
  const u = h ? 30 : 0, b = ue(a), i = s.nodeWidth ? s.nodeWidth * B : 960, x = s.nodeHeight ? s.nodeHeight * B : 500, S = i, v = x + u;
  ...
  const z = b.append("g").attr("transform", `translate(0, ${u})`).attr("class", "treemapContainer"), E = te(g).sum((e) => e.value ?? 0).sort((e, o) => (o.value ?? 0) - (e.value ?? 0)), ae = Qe().size([i, x]).paddingTop(
  ...
  W.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", X).attr("class", "treemapSectionHeader").attr("fill", "none").attr("fill-opacity", 0.6).attr("stroke-width", 0.6).attr("style", (e) => e.depth === 0 ? "display: none;" : ""), W.append("clipPath").attr("id", (e, o) => `clip-section-${a}-${o}`).append("rect").attr("width", (e) => Math.max(0, e.x1 - e.x0 - 12)).attr("height", X), W.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", (e) => e.y1 - e.y0).attr("class", (e, o) => `treemapSection section${o}`).attr("fill", (e) => m(e.data.name)).attr("fill-opacity", 0.6).attr("stroke", (e) => M(e.data.name)).attr("stroke-width", 2).attr("stroke-opacity", 0.4).attr("style", (e) => {
    ...
    const F = Math.max(15, A), y = o.node();
    if (y.getComputedTextLength() > F) {
      const T = "...";
      let L = f;
      for (; L.length > 0; ) {
        if (L = f.substring(0, L.length - 1), L.length === 0) {
          o.text(T), y.getComputedTextLength() > F && o.text("");
          break;
        }
        if (o.text(L + T), y.getComputedTextLength() <= F)
          break;
      }
    }
  ...
  Y.append("rect").attr("width", (e) => e.x1 - e.x0).attr("height", (e) => e.y1 - e.y0).attr("class", "treemapLeaf").attr("fill", (e) => e.parent ? m(e.parent.data.name) : m(e.data.name)).attr("style", (e) => P({ cssCompiledStyles: e.data.cssCompiledStyles }).nodeStyles).attr("fill-opacity", 0.3).attr("stroke", (e) => e.parent ? m(e.parent.data.name) : m(e.data.name)).attr("stroke-width", 3), Y.append("clipPath").attr("id", (e, o) => `clip-${a}-${o}`).append("rect").attr("width", (e) => Math.max(0, e.x1 - e.x0 - 4)).attr("height", (e) => Math.max(0, e.y1 - e.y0 - 4)), Y.append("text").attr("class", "treemapLabel").attr("x", (e) => (e.x1 - e.x0) / 2).attr("y", (e) => (e.y1 - e.y0) / 2).attr("style", (e) => {
    ...
    const o = j(this), f = e.x1 - e.x0, C = e.y1 - e.y0, $ = o.node(), A = 4, D = f - 2 * A, F = C - 2 * A;
    if (D < 10 || F < 10) {
      o.style("display", "none");
      return;
    }
    let y = parseInt(o.style("font-size"), 10);
    const _ = 8, T = 28, L = 0.6, k = 6, I = 2;
    ...
    o.style("font-size", `${y}px`), ($.getComputedTextLength() > D || y < _ || F < y) && o.style("display", "none");
  }), s.showValues !== !1 && Y.append("text").attr("class", "treemapValue").attr("x", (o) => (o.x1 - o.x0) / 2).attr("y", function(o) {
    return (o.y1 - o.y0) / 2;
  }).attr("style", (o) => {
    ...
    const k = (o.y1 - o.y0) / 2 + A / 2 + _;
    f.attr("y", k);
    const I = o.x1 - o.x0, ce = o.y1 - o.y0 - 4, de = I - 2 * 4;
    f.node().getComputedTextLength() > de || k + T > ce || T < y ? f.style("display", "none") : f.style("display", null);
  });
  ...
  const a = he(), l = ee(), n = J(a, l.themeVariables), r = J(st, t), s = r.titleColor ?? n.titleColor, d = r.labelColor ?? n.textColor, h = r.valueColor ?? n.textColor;
  return `
  .treemapNode.section {
