import { b as Ve, G as g, i as m, v as E } from "./graph-a88aAQlo.js";
import { i as z, c as I, k as Ye, o as $e, p as ve, q as pe, t as De, u as we, v as qe, w as be, d as V, x as We, b as ze, y as Xe, n as f, m as C, r as B } from "./_baseUniq-5vmkzwto.js";
import { f as O, b as me, a as He, c as Ue, m as w, d as P } from "./min-YjuzaSlk.js";
import { b1 as M, bn as Je, bo as Ke, b8 as ge, bp as S, aU as ye, bq as Ze, aG as Qe, br as en, bs as nn, aI as xe, bt as rn, b7 as Ee, aH as ke, a$ as tn, ba as an, bu as X } from "./index-DWbaqf43.js";
var on = /\s/;
function un(e) {
...
function Nn(e, n, r) {
  ...
  if (!t)
    return -1;
  var i = r == null ? 0 : wn(r);
  return i < 0 && (i = On(t + i, 0)), $e(e, I(n), i);
}
var U = kn(Nn);
function Ln(e, n) {
...
var In = Object.prototype, Cn = In.hasOwnProperty;
function Rn(e, n) {
  return e != null && Cn.call(e, n);
}
function Ne(e, n) {
...
function j(e, n) {
  var r = {};
  return n = I(n), pe(e, function(t, i, o) {
    nn(r, i, n(t, i, o));
  }), r;
}
function y(e) {
...
function J(e, n) {
  return e && e.length ? me(e, I(n), He) : void 0;
}
function Tn(e, n, r, t) {
  if (!M(e))
    return e;
...
function ft(e, n) {
  n("    makeSpaceForEdgeLabels", () => xt(e)), n("    removeSelfEdges", () => Ct(e)), n("    acyclic", () => Zn(e)), n("    nestingGraph.run", () => Lr(e)), n("    rank", () => kr(Le(e))), n("    injectEdgeLabelProxies", () => Et(e)), n("    removeEmptyRanks", () => tr(e)), n("    nestingGraph.cleanup", () => Ir(e)), n("    normalizeRanks", () => rr(e)), n("    assignRankMinMax", () => kt(e)), n("    removeEdgeLabelProxies", () => Ot(e)), n("    normalize.run", () => cr(e)), n("    parentDummyChains", () => zr(e)), n("    addBorderSegments", () => or(e)), n("    order", () => qr(e)), n("    insertSelfEdges", () => Rt(e)), n("    adjustCoordinateSystem", () => ur(e)), n("    position", () => dt(e)), n("    positionSelfEdges", () => Tt(e)), n("    removeBorderNodes", () => It(e)), n("    normalize.undo", () => hr(e)), n("    fixupEdgeLabelCoords", () => Pt(e)), n("    undoCoordinateSystem", () => dr(e)), n("    translateGraph", () => Nt(e)), n("    assignNodeIntersects", () => Lt(e)), n("    reversePoints", () => _t(e)), n("    acyclic.undo", () => er(e));
}
function ct(e, n) {
  f(e.nodes(), function(r) {
