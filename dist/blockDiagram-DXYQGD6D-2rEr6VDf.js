import { g as ge } from "./chunk-FMBD7UC4-BcO4nba_.js";
import { _ as d, D as lt, d as C, e as de, l as v, z as ue, B as pe, ai as fe, R as xe, S as ye, c as M, O as be, aj as Y, ak as vt, al as at, am as we, u as st, k as me, an as Le, i as Ct, ao as Ot, ap as Se } from "./index-DWbaqf43.js";
import { c as ve } from "./clone-DcIIfEiY.js";
import { G as Ee } from "./graph-a88aAQlo.js";
import { c as _e } from "./channel-qLWyD7mH.js";
var bt = function() {
  var e = /* @__PURE__ */ d(function(N, y, u, p) {
    for (u = u || {}, p = N.length; p--; u[N[p]] = y) ;
    return u;
  }, "o"), t = [1, 15], a = [1, 7], i = [1, 13], l = [1, 14], s = [1, 19], r = [1, 16], n = [1, 17], c = [1, 18], x = [8, 30], h = [8, 10, 21, 28, 29, 30, 31, 39, 43, 46], f = [1, 23], w = [1, 24], b = [8, 10, 15, 16, 21, 28, 29, 30, 31, 39, 43, 46], m = [8, 10, 15, 16, 21, 27, 28, 29, 30, 31, 39, 43, 46], _ = [1, 49], L = {
    ...
    performAction: /* @__PURE__ */ d(function(y, u, p, S, E, o, k) {
      var g = o.length - 1;
      switch (E) {
        case 4:
    ...
    parse: /* @__PURE__ */ d(function(y) {
      var u = this, p = [0], S = [], E = [null], o = [], k = this.table, g = "", D = 0, T = 0, K = 2, P = 1, Q = o.slice.call(arguments, 1), R = Object.create(this.lexer), U = { yy: {} };
      ...
      for (var H, $, V, ft, tt = {}, ct, J, Bt, ot; ; ) {
        if ($ = p[p.length - 1], this.defaultActions[$] ? V = this.defaultActions[$] : ((H === null || typeof H > "u") && (H = It()), V = k[$] && k[$][H]), typeof V > "u" || !V.length || !V[0]) {
          var xt = "";
          ot = [];
          for (ct in k[$])
        ...
        switch (V[0]) {
          ...
          case 2:
            if (J = this.productions_[V[1]][1], tt.$ = E[E.length - J], tt._$ = {
              ...
              return ft;
            J && (p = p.slice(0, -1 * J * 2), E = E.slice(0, -1 * J), o = o.slice(0, -1 * J)), p.push(this.productions_[V[1]][0]), E.push(tt.$), o.push(tt._$), Bt = k[p[p.length - 2]][p[p.length - 1]], p.push(Bt);
            break;
          case 3:
            return !0;
        }
...
bt.parser = bt;
var ke = bt, Z = /* @__PURE__ */ new Map(), Et = [], wt = /* @__PURE__ */ new Map(), Rt = "color", zt = "fill", De = "bgFill", Xt = ",", Te = M(), gt = /* @__PURE__ */ new Map(), _t = "", Ne = /* @__PURE__ */ d((e) => me.sanitizeText(e, Te), "sanitizeText"), Ie = /* @__PURE__ */ d(function(e, t = "") {
  let a = gt.get(e);
  a || (a = { id: e, styles: [], textStyles: [] }, gt.set(e, a)), t != null && t.split(Xt).forEach((i) => {
  ...
  for (const r of a) {
    ...
    ), r.label && (r.label = Ne(r.label)), r.type === "classDef") {
      Ie(r.id, r.css);
      continue;
    }
    ...
    if (r.type === "column-setting")
      ...
      const n = Z.get(r.id);
      if (n === void 0 ? Z.set(r.id, r) : (r.type !== "na" && (n.type = r.type), r.label !== r.id && (n.label = r.label)), r.children && jt(r.children, r), r.type === "space") {
        const c = r.width ?? 1;
        for (let x = 0; x < c; x++) {
          const h = ve(r);
  ...
  t.children = i;
}, "populateBlockDatabase"), kt = [], nt = { id: "root", type: "composite", children: [], columns: -1 }, Oe = /* @__PURE__ */ d(() => {
  v.debug("Clear called"), ue(), nt = { id: "root", type: "composite", children: [], columns: -1 }, Z = /* @__PURE__ */ new Map([["root", nt]]), kt = [], gt = /* @__PURE__ */ new Map(), Et = [], wt = /* @__PURE__ */ new Map(), _t = "";
}, "clear");
function Vt(e) {
...
var At = 0, Re = /* @__PURE__ */ d(() => (At++, "id-" + Math.random().toString(36).substr(2, 12) + "-" + At), "generateId"), ze = /* @__PURE__ */ d((e) => {
...
}, "getColumns"), Me = /* @__PURE__ */ d(() => [...Z.values()], "getBlocksFlat"), Fe = /* @__PURE__ */ d(() => kt || [], "getBlocks"), Pe = /* @__PURE__ */ d(() => Et, "getEdges"), We = /* @__PURE__ */ d((e) => Z.get(e), "getBlock"), Ye = /* @__PURE__ */ d((e) => {
  Z.set(e.id, e);
}, "setBlock"), He = /* @__PURE__ */ d((e) => {
  _t = e;
}, "setDiagramId"), Ke = /* @__PURE__ */ d(() => _t, "getDiagramId"), Ue = /* @__PURE__ */ d(() => v, "getLogger"), Xe = /* @__PURE__ */ d(function() {
  return gt;
}, "getClasses"), je = {
  ...
  setDiagramId: He,
  getDiagramId: Ke
}, Ve = je, yt = /* @__PURE__ */ d((e, t) => {
  const a = _e, i = a(e, "r"), l = a(e, "g"), s = a(e, "b");
  return pe(i, l, s, t);
}, "fade"), Ge = /* @__PURE__ */ d((e) => `.label {
  ...
  ${ge()}
`, "getStyles"), Ze = Ge, qe = /* @__PURE__ */ d((e, t, a, i) => {
  t.forEach((l) => {
    nr[l](e, a, i);
  });
}, "insertMarkers"), Je = /* @__PURE__ */ d((e, t, a) => {
...
}, "composition"), $e = /* @__PURE__ */ d((e, t, a) => {
...
}, "aggregation"), tr = /* @__PURE__ */ d((e, t, a) => {
...
}, "dependency"), er = /* @__PURE__ */ d((e, t, a) => {
  ...
  cross: sr,
  barb: ir
}, lr = qe, Kt, Ut, A = ((Ut = (Kt = M()) == null ? void 0 : Kt.block) == null ? void 0 : Ut.padding) ?? 8;
function mt(e, t) {
...
function Dt(e, t) {
  ...
  e.children.length > 0) {
    ...
    let o = (x = e == null ? void 0 : e.size) != null && x.x ? ((h = e == null ? void 0 : e.size) == null ? void 0 : h.x) + (-((f = e == null ? void 0 : e.size) == null ? void 0 : f.width) / 2 || 0) : -A, k = 0;
    for (const g of e.children) {
      const D = e;
      if (!g.size)
        continue;
      const { width: T, height: K } = g.size, { px: P, py: Q } = mt(a, E);
      if (Q != k && (k = Q, o = (w = e == null ? void 0 : e.size) != null && w.x ? ((b = e == null ? void 0 : e.size) == null ? void 0 : b.x) + (-((m = e == null ? void 0 : e.size) == null ? void 0 : m.width) / 2 || 0) : -A, v.debug("New row in layout for block", e.id, " and child ", g.id, k)), v.debug(
...
function qt(e) {
  ...
  const { minX: a, minY: i, maxX: l, maxY: s } = Tt(t), r = s - i, n = l - a;
  return { x: a, y: i, width: n, height: r };
}
d(qt, "layout");
var or = /* @__PURE__ */ d(async (e, t, a, i = !1, l = !1) => {
  let s = t || "";
...
}, "createLabel"), G = or, hr = /* @__PURE__ */ d((e, t, a, i, l) => {
  t.arrowTypeStart && Mt(e, "start", t.arrowTypeStart, a, i, l), t.arrowTypeEnd && Mt(e, "end", t.arrowTypeEnd, a, i, l);
}, "addEdgeMarkers"), gr = {
  arrow_cross: "cross",
  arrow_point: "point",
  arrow_barb: "barb",
...
}, "addEdgeMarker"), Lt = {}, W = {}, dr = /* @__PURE__ */ d(async (e, t) => {
...
var ur = /* @__PURE__ */ d((e, t) => {
...
}, "cutPathAtIntersect"), xr = /* @__PURE__ */ d(function(e, t, a, i, l, s, r) {
  let n = a.points;
  v.debug("abc88 InsertEdge: edge=", a, "e=", t);
  let c = !1;
  const x = s.node(t.v);
  var h = s.node(t.w);
  h != null && h.intersect && (x != null && x.intersect) && (n = n.slice(1, a.points.length - 1), n.unshift(x.intersect(n[0])), n.push(h.intersect(n[n.length - 1]))), a.toCluster && (v.debug("to cluster abc88", i[a.toCluster]), n = Ft(a.points, i[a.toCluster].node), c = !0), a.fromCluster && (v.debug("from cluster abc88", i[a.fromCluster]), n = Ft(n.reverse(), i[a.fromCluster].node).reverse(), c = !0);
  const f = n.filter((y) => !Number.isNaN(y.y));
  let w = ye;
  a.curve && (l === "graph" || l === "flowchart") && (w = a.curve);
  const { x: b, y: m } = fe(a), _ = xe().x(b).y(m).curve(w);
  let L;
  switch (a.thickness) {
    case "normal":
  ...
  const B = e.append("path").attr("d", _(f)).attr("id", a.id).attr("class", " " + L + (a.classes ? " " + a.classes : "")).attr("style", a.style);
  let I = "";
  ...
  return t;
}, "expandAndDeduplicateDirections"), br = /* @__PURE__ */ d((e, t, a) => {
  const i = yr(e), l = 2, s = t.height + 2 * a.padding, r = s / l, n = t.width + 2 * r + a.padding, c = a.padding / 2;
...
function ee(e, t, a, i) {
  ...
  if (l = t.y - e.y, r = e.x - t.x, c = t.x * e.y - e.x * t.y, w = l * a.x + r * a.y + c, b = l * i.x + r * i.y + c, !(w !== 0 && b !== 0 && St(w, b)) && (s = i.y - a.y, n = a.x - i.x, x = i.x * a.y - a.x * i.y, h = s * e.x + n * e.y + x, f = s * t.x + n * t.y + x, !(h !== 0 && f !== 0 && St(h, f)) && (m = l * n - s * r, m !== 0)))
    return _ = Math.abs(m / 2), L = r * x - n * c, B = L < 0 ? (L - _) / m : (L + _) / m, L = s * c - l * x, I = L < 0 ? (L - _) / m : (L + _) / m, { x: B, y: I };
}
d(ee, "intersectLine");
function St(e, t) {
  return e * t > 0;
...
function re(e, t, a) {
  ...
  for (var c = i - e.width / 2 - r, x = l - e.height / 2 - n, h = 0; h < t.length; h++) {
    var f = t[h], w = t[h < t.length - 1 ? h + 1 : 0], b = Lr(
      e,
      a,
      { x: c + f.x, y: x + f.y },
      { x: c + w.x, y: x + w.y }
  ...
  return s.length ? (s.length > 1 && s.sort(function(m, _) {
    var L = m.x - a.x, B = m.y - a.y, I = Math.sqrt(L * L + B * B), N = _.x - a.x, y = _.y - a.y, u = Math.sqrt(N * N + y * y);
...
}, "note"), kr = _r, Pt = /* @__PURE__ */ d((e) => e ? " " + e : "", "formatClass"), j = /* @__PURE__ */ d((e, t) => `${t || "node default"}${Pt(e.classes)} ${Pt(
  e.class
)}`, "getClassesFromNode"), Wt = /* @__PURE__ */ d(async (e, t) => {
...
}, "choice"), Tr = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await F(
    e,
    t,
    j(t, void 0),
...
}, "hexagon"), Nr = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await F(e, t, void 0, !0), l = 2, s = i.height + 2 * t.padding, r = s / l, n = i.width + 2 * r + t.padding, c = br(t.directions, i, t), x = q(a, n, s, c);
  return x.attr("style", t.style), z(t, x), t.intersect = function(h) {
    return O.polygon(t, c, h);
  }, a;
}, "block_arrow"), Ir = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await F(
    e,
    t,
    j(t, void 0),
...
}, "lean_left"), Or = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await F(
    e,
    t,
    j(t, void 0),
...
}, "trapezoid"), Rr = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await F(
    e,
    t,
    j(t, void 0),
...
}, "inv_trapezoid"), zr = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await F(
    e,
    t,
    j(t, void 0),
...
}, "rect_right_inv_arrow"), Ar = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await F(
    e,
    t,
    j(t, void 0),
...
}, "cylinder"), Mr = /* @__PURE__ */ d(async (e, t) => {
...
}, "composite"), Pr = /* @__PURE__ */ d(async (e, t) => {
...
var Wr = /* @__PURE__ */ d(async (e, t) => {
  ...
  ), l.attr("class", "outer title-state").attr("x", -h.width / 2 - m).attr("y", -h.height / 2 - m).attr("width", h.width + t.padding).attr("height", h.height + t.padding), s.attr("class", "divider").attr("x1", -h.width / 2 - m).attr("x2", h.width / 2 + m).attr("y1", -h.height / 2 - m + w.height + m).attr("y2", -h.height / 2 - m + w.height + m), z(t, l), t.intersect = function(_) {
    return O.rect(t, _);
  }, i;
}, "rectWithTitle"), Yr = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await F(
    e,
    t,
    j(t, void 0),
...
}, "stadium"), Hr = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i, halfPadding: l } = await F(
    e,
    t,
    j(t, void 0),
...
}, "circle"), Kr = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i, halfPadding: l } = await F(
    e,
    t,
    j(t, void 0),
...
}, "doublecircle"), Ur = /* @__PURE__ */ d(async (e, t) => {
  const { shapeSvg: a, bbox: i } = await F(
    e,
    t,
    j(t, void 0),
  ...
  let b = 0;
  const m = (E = t.classData.annotations) == null ? void 0 : E[0], _ = t.classData.annotations[0] ? "«" + t.classData.annotations[0] + "»" : "", L = await G(
    w,
    _,
    t.labelStyle,
    !0,
  ...
  t.classData.members.forEach(async (o) => {
    ...
    const D = await G(
      w,
      g,
      k.cssStyle ? k.cssStyle : t.labelStyle,
      !0,
      !0
    );
    let T = D.getBBox();
  ...
  join: Yt,
  class_box: Vr
}, ht = {}, ae = /* @__PURE__ */ d(async (e, t, a) => {
  let i, l;
  if (t.link) {
    let s;
    M().securityLevel === "sandbox" ? s = "_top" : t.linkTarget && (s = t.linkTarget || "_blank"), i = e.insert("svg:a").attr("xlink:href", t.link).attr("target", s), l = await Ht[t.shape](i, t, a);
  } else
    l = await Ht[t.shape](e, t, a), i = l;
...
function Nt(e, t, a = !1) {
  ...
  const c = Le((i == null ? void 0 : i.styles) ?? []), x = i.label, h = i.size ?? { width: 0, height: 0, x: 0, y: 0 }, f = t.getDiagramId();
  return {
...
async function se(e, t, a) {
  ...
  if (i.type === "group")
    return;
  const l = lt(), s = await ae(e, i, { config: l }), r = s.node().getBBox(), n = a.getBlock(i.id);
...
d(ce, "insertEdges");
var Zr = /* @__PURE__ */ d(function(e, t) {
  return t.db.getClasses();
}, "getClasses"), qr = /* @__PURE__ */ d(async function(e, t, a, i) {
  ...
  if (await le(m, f, r), await ce(m, b, w, r, t), _) {
    const L = _, B = Math.max(1, Math.round(0.125 * (L.width / L.height))), I = L.height + B + 10, N = L.width + 10, { useMaxWidth: y } = s;
    de(x, I, N, !!y), v.debug("Here Bounds", _, L), x.attr(
      "viewBox",
