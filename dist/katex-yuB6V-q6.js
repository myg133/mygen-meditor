...
var I1 = /([A-Z])/g, Tt = (r) => r.replace(I1, "-$1").toLowerCase(), N1 = {
  "&": "&amp;",
  ">": "&gt;",
  "<": "&lt;",
  '"': "&quot;",
  "'": "&#x27;"
}, O1 = /[&><"']/g, n0 = (r) => String(r).replace(O1, (e) => N1[e]), De = (r) => r.type === "ordgroup" || r.type === "color" ? r.body.length === 1 ? De(r.body[0]) : r : r.type === "font" ? De(r.body) : r, H1 = /* @__PURE__ */ new Set(["mathord", "textord", "atom"]), C0 = (r) => H1.has(De(r).type), F1 = (r) => {
...
var Dt = 0, qe = 1, _0 = 2, B0 = 3, he = 4, g0 = 5, ee = 6, u0 = 7, w0 = [new O0(Dt, 0, !1), new O0(qe, 0, !0), new O0(_0, 1, !1), new O0(B0, 1, !0), new O0(he, 2, !1), new O0(g0, 2, !0), new O0(ee, 3, !1), new O0(u0, 3, !0)], P1 = [he, g0, he, g0, ee, u0, ee, u0], G1 = [g0, g0, g0, g0, u0, u0, u0, u0], U1 = [_0, B0, he, g0, ee, u0, ee, u0], V1 = [B0, B0, g0, g0, u0, u0, u0, u0], X1 = [qe, qe, B0, B0, g0, g0, u0, u0], Y1 = [Dt, qe, _0, B0, _0, B0, _0, B0], N = {
  DISPLAY: w0[Dt],
  TEXT: w0[_0],
  SCRIPT: w0[he],
  SCRIPTSCRIPT: w0[ee]
...
var vt = {
  ...
  for (var l of Object.keys(this.attributes)) {
    if (na.test(l))
      throw new S("Invalid attribute name '" + l + "'");
...
class f0 {
  ...
  toMarkup() {
    var e = !1, t = "<span";
    this.classes.length && (e = !0, t += ' class="', t += n0(L0(this.classes)), t += '"');
    var a = "";
...
var oa = (r) => r instanceof ne || r instanceof Oe || r instanceof ae, k0 = {
  "AMS-Regular": {
    32: [0, 0, 0, 0, 0.25],
...
function Ct(r, e, t) {
  ...
  if (!n && r[0] in _t && (a = _t[r[0]].charCodeAt(0), n = k0[e][a]), !n && t === "text" && Cr(a) && (n = k0[e][77]), n)
    return {
      depth: n[0],
      height: n[1],
      italic: n[2],
...
function ma(r) {
  ...
  if (r >= 5 ? e = 0 : r >= 3 ? e = 1 : e = 2, !Je[e]) {
    ...
    for (var a in xe)
      xe.hasOwnProperty(a) && (t[a] = xe[a][e]);
  }
  return Je[e];
}
var ca = {
...
var Se = [
  ...
  if (h) {
    ...
    typeof console < "u" && console.warn("No character metrics " + ("for '" + e + "' in style '" + t + "' and mode '" + a + "'")), c = new f0(e, 0, 0, 0, 0, 0, l);
  if (n) {
  ...
  if (l.charCodeAt(0) === 55349 && ([v, g] = fa(l, n)), v.length > 0)
    return s0(l, v, n, t, u.concat(g));
  if (c) {
    var b, y;
    if (c === "boldsymbol") {
      var x = va(l, n, t, u, a);
    ...
    if (He(l, b, n).metrics)
      return s0(l, b, n, t, u.concat(y));
    if (Nr.hasOwnProperty(l) && b.slice(0, 10) === "Typewriter") {
      for (var M = [], T = 0; T < l.length; T++)
        M.push(s0(l[T], b, n, t, u.concat(y)));
      return E0(M);
    }
  }
  if (a === "mathord")
    return s0(l, "Math-Italic", n, t, u.concat(["mathnormal"]));
  if (a === "textord") {
    var C = $[n][l] && $[n][l].font;
    if (C === "ams") {
  ...
  var [a, n, l] = Fr[e], u = new P0(a), h = new D0([u], {
    width: A(n),
    height: A(l),
...
}, wa = /* @__PURE__ */ new Set(["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"]), ka = /* @__PURE__ */ new Set(["rightmost", "mrel", "mclose", "mpunct"]), Sa = {
  display: N.DISPLAY,
  text: N.TEXT,
  script: N.SCRIPT,
...
function kt(r, e) {
  ...
  var v;
  t ? (v = Ae(a0(t, e, !0), e), v.classes = ["tag"], l.push(v)) : n && l.push(n);
...
var Xr = function(e) {
  ...
  if (a.output === "html") {
    ...
    var h = ir(e, t, n, a.displayMode, !1), c = kt(e, n);
    l = k(["katex"], [h, c]);
  }
  return Yr(l, a);
}, Da = function(e, t, a) {
...
}, Ea = /* @__PURE__ */ new Set(["widehat", "widecheck", "widetilde", "utilde"]), Pe = function(e, t) {
  function a() {
    ...
    if (Ea.has(c)) {
      ...
      for (var i0 = 0; i0 < P; i0++) {
        var t0 = new P0(O[i0]), X0 = new D0([t0], {
          width: "400em",
          height: A(L),
          viewBox: "0 0 " + h + " " + V,
...
var Wr = (r) => {
  ...
  if (a.isStretchy)
    ...
    var x, M;
    a.label === "\\vec" ? (x = Lr("vec", e), M = Fr.vec[1]) : (x = Fe({
      mode: a.mode,
      text: a.label
    }, e, "textord"), x = sa(x), x.italic = 0, M = x.width, g && (b += x.depth)), y = k(["accent-body"], [x]);
    var T = a.label === "\\textcircled";
    T && (y.classes.push("accent-full"), b = l.height);
    var C = h;
    T || (C -= M / 2), y.style.left = A(C), a.label === "\\textcircled" && (y.style.top = ".2em"), y = G({
      positionType: "firstBaseline",
      children: [{
        type: "elem",
        elem: l
...
var Na = {
  ...
  mode: "math",
  style: "display"
}), or = (r) => r.type === "textord" && r.text === "@", Oa = (r, e) => (r.type === "mathord" || r.type === "atom") && r.text === e;
function Ha(r, e, t) {
  var a = Na[r];
  switch (a) {
    case "\\\\cdrightarrow":
    ...
    case "\\downarrow": {
      var n = t.callFunction("\\\\cdleft", [e[0]], []), l = {
        ...
        mode: "math",
        family: "rel"
      }, u = t.callFunction("\\Big", [l], []), h = t.callFunction("\\\\cdright", [e[1]], []), c = {
        type: "ordgroup",
        mode: "math",
        body: [n, u, h]
      };
...
B({
  ...
  handler(r, e) {
    for (var {
      parser: t
    } = r, a = H(e[0], "ordgroup"), n = a.body, l = "", u = 0; u < n.length; u++) {
      var h = H(n[u], "textord");
      l += h.text;
    }
    var c = parseInt(l), v;
    if (isNaN(c))
      throw new S("\\@char has non-numeric argument " + l);
    if (c < 0 || c >= 1114111)
      throw new S("\\@char with invalid code point " + l);
...
B({
  ...
  handler(r, e, t) {
    var {
      parser: a
    } = r, n = a.gullet.future().text === "[" ? a.parseSizeGroup(!0) : null, l = !a.settings.displayMode || !a.settings.useStrictBehavior("newLineInDisplayMode", "In LaTeX, \\\\ or \\newline does nothing in display mode");
    return {
      type: "cr",
      mode: a.mode,
      newLine: l,
...
B({
  ...
  handler(r) {
    var {
      parser: e,
      funcName: t
    } = r, a = Qr(e.gullet.popToken()), n = e.gullet.popToken(), l = e.gullet.popToken();
...
var ue = function(e, t, a) {
  ...
  var n = k0["Size4-Regular"][e.charCodeAt(0)] ? k0["Size4-Regular"][e.charCodeAt(0)][4] : k0["Size1-Regular"][e.charCodeAt(0)][4], l = new P0("inner", ta(e, Math.round(1e3 * t))), u = new D0([l], {
    width: A(n),
    height: A(t),
    // Override CSS rule `.katex svg { width: 100% }`
    style: "width:" + A(n),
  ...
  type: "kern",
  size: -1 * zt
}, Ua = /* @__PURE__ */ new Set(["|", "\\lvert", "\\rvert", "\\vert"]), Va = /* @__PURE__ */ new Set(["\\|", "\\lVert", "\\rVert", "\\Vert"]), r1 = function(e, t, a, n, l, u) {
  var h, c, v, g, b = "", y = 0;
  h = v = g = e, c = null;
  var x = "Size1-Regular";
  ...
  var i0 = X / 2 - h0, t0 = [];
  if (b.length > 0) {
    var X0 = X - T - O, m0 = Math.round(X * 1e3), y0 = ra(b, Math.round(X0 * 1e3)), R0 = new P0(b, y0), j0 = A(y / 1e3), Z0 = A(m0 / 1e3), Ze = new D0([R0], {
      width: j0,
      height: Z0,
      viewBox: "0 0 " + y + " " + m0
    }), I0 = G0([], [Ze], n);
    I0.height = m0 / 1e3, I0.style.width = j0, I0.style.height = Z0, t0.push({
      type: "elem",
      elem: I0
    });
  } else {
  ...
  var x0 = n.havingBaseStyle(N.TEXT), fe = G({
    positionType: "bottom",
    positionData: i0,
    children: t0
  });
  ...
  var u = ea(e, n, a), h = new P0(e, u), c = new D0([h], {
  ...
  var h = n.fontMetrics().axisHeight * n.sizeMultiplier, c = 901, v = 5 / n.fontMetrics().ptPerEm, g = Math.max(t - h, a + h), b = Math.max(
...
}, Za = /* @__PURE__ */ new Set(["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."]);
function Xe(r, e) {
  var t = Ue(r);
  if (t && Za.has(t.text))
    return t;
...
var Ye = (r, e) => {
  ...
  if (a === "sout")
    l = k(["stretchy", "sout"]), l.height = e.fontMetrics().defaultRuleThickness / n, u = -0.5 * e.fontMetrics().xHeight;
  else if (a === "phase") {
    var c = K({
      number: 0.6,
      unit: "pt"
    ...
    var y = Math.floor(1e3 * b * n), x = Q1(y), M = new D0([new P0("phase", x)], {
      width: "400em",
      height: A(y / 1e3),
...
B({
  ...
  handler(r, e, t) {
    var {
      parser: a,
      funcName: n
    } = r, l = H(e[0], "color-token").color, u = e[1];
    return {
      type: "enclose",
      mode: a.mode,
      label: n,
...
B({
  ...
  handler(r, e, t) {
    var {
      parser: a,
      funcName: n
    } = r, l = H(e[0], "color-token").color, u = H(e[1], "color-token").color, h = e[2];
    return {
      type: "enclose",
      mode: a.mode,
      label: n,
...
function V0(r, e, t) {
  ...
  if (r.gullet.beginGroup(), v || r.gullet.macros.set("\\cr", "\\\\\\relax"), !u) {
    ...
    if (x == null)
      ...
      throw new S("Invalid \\arraystretch: " + x);
  }
  r.gullet.beginGroup();
  ...
  function F() {
    I && (r.gullet.macros.get("\\df@tag") ? (I.push(r.subparse([new d0("\\df@tag")])), r.gullet.macros.set("\\df@tag", void 0, !0)) : I.push(!!c && r.gullet.macros.get("\\@eqnsw") === "1"));
  }
  for (O(), q.push(cr(r)); ; ) {
    ...
    if (P === "&") {
      ...
      r.consume();
      var W = void 0;
      r.gullet.future().text !== " " && (W = r.parseSizeGroup(!0)), C.push(W ? W.value : null), F(), q.push(cr(r)), M = [], T.push(M), O();
    } else
...
var z0 = function(e, t) {
  var a, n, l = e.body.length, u = e.hLinesBeforeRow, h = 0, c = new Array(l), v = [], g = Math.max(
  ...
  var M = e.colSeparationType === "CD" ? K({
    number: 3,
    unit: "ex"
  }, t) : 12 * b, T = 3 * b, C = e.arraystretch * M, q = 0.7 * C, I = 0.3 * C, O = 0;
  function F(be) {
  ...
  for (
    ...
    for (var se, x0 = X0[R0], fe = !0; ((Vt = x0) == null ? void 0 : Vt.type) === "separator"; ) {
      var Vt;
      if (fe || (y0 = k(["arraycolsep"], []), y0.style.width = A(t.fontMetrics().doubleRuleSep), m0.push(y0)), x0.separator === "|" || x0.separator === ":") {
        ...
        throw new S("Invalid separator type: " + x0.separator);
      R0++, x0 = X0[R0], fe = !1;
    }
    if (!(n >= h)) {
      var J0 = void 0;
      ...
      for (a = 0; a < l; ++a) {
        ...
        if (pe) {
          var T1 = ve.pos - t0;
          pe.depth = ve.depth, pe.height = ve.height, $t.push({
            type: "elem",
            elem: pe,
            shift: T1
          });
  ...
  var ge = k(["mtable"], m0);
  if (v.length > 0) {
    for (var C1 = te("hline", t, g), q1 = te("hdashline", t, g), Ke = [{
      type: "elem",
      elem: ge,
      shift: 0
    }]; v.length > 0; ) {
  ...
  if (e.cols && e.cols.length > 0) {
    var M = e.cols, T = "", C = !1, q = 0, I = M.length;
    M[0].type === "separator" && (y += "top ", q = 1), M[M.length - 1].type === "separator" && (y += "bottom ", I -= 1);
    for (var O = q; O < I; O++) {
      var F = M[O];
      F.type === "align" ? (x += Ja[F.align], C && (T += "none "), C = !0) : F.type === "separator" && C && (T += F.separator === "|" ? "solid " : "dashed ", C = !1);
    }
  ...
  for (var h0 = 1; h0 < X.length - 1; h0++)
    W += X[h0].length === 0 ? "none " : X[h0][0] ? "dashed " : "solid ";
  ...
  var a = [], n = e.envName.includes("at") ? "alignat" : "align", l = e.envName === "split", u = V0(e.parser, {
    cols: a,
    addJot: !0,
  ...
  u.body.forEach(function(q) {
    ...
    if (x)
      ...
      var V = q.length / 2;
      if (h < V)
        throw new S("Too many math in a row: " + ("expected " + h + ", but got " + V), q[0]);
    }
  });
  for (var M = 0; M < c; ++M) {
    var T = "r", C = 0;
    M % 2 === 1 ? T = "l" : M > 0 && x && (C = 1), a[M] = {
      type: "align",
      align: T,
      pregap: C,
      postgap: 0
...
B({
  ...
  handler(r, e) {
    ...
    for (var l = "", u = 0; u < n.body.length; ++u)
      l += H(n.body[u], "textord").text;
    if (a === "\\begin") {
      if (!dr.hasOwnProperty(l))
        throw new S("No such environment: " + l, n);
      var h = dr[l], {
        args: c,
        optArgs: v
...
var Qa = (r, e) => {
  ...
  var V, L;
  return r.leftDelim == null ? V = me(e, ["mopen"]) : V = At(r.leftDelim, F, !0, e.havingStyle(t), r.mode, ["mopen"]), r.continued ? L = k([]) : r.rightDelim == null ? L = me(e, ["mclose"]) : L = At(r.rightDelim, F, !0, e.havingStyle(t), r.mode, ["mclose"]), k(["mord"].concat(l.sizingClasses(e)), [V, k(["mfrac"], [C]), L], e);
}, _a = (r, e) => {
...
B({
  ...
  handler: (r, e) => {
    ...
    return v || a.startsWith("\\d") ? g = "display" : a.startsWith("\\t") && (g = "text"), d1({
      type: "genfrac",
      mode: t.mode,
      numer: n,
      denom: l,
...
B({
  ...
  handler(r, e) {
    var {
      parser: t
    } = r, a = e[4], n = e[5], l = Ne(e[0]), u = l.type === "atom" && l.family === "open" ? pr(l.text) : null, h = Ne(e[1]), c = h.type === "atom" && h.family === "close" ? pr(h.text) : null, v = H(e[2], "size"), g, b = null;
    ...
    if (x.type === "ordgroup") {
      ...
      x = H(x, "textord"), y = vr[Number(x.text)];
    return d1({
      type: "genfrac",
      mode: t.mode,
      numer: a,
...
B({
  ...
  handler(r, e) {
    ...
    a.switchMode("math");
    var l = t === "\\(" ? "\\)" : "$", u = a.parseExpression(!1, l);
...
var v1 = (r, e, t, a, n, l, u) => {
  ...
  if (l.symbol) {
    ...
    for (var M = [], T = 1; T < l.name.length; T++)
      M.push(qt(l.name[T], l.mode, e));
    c = k(["mop"], M, e);
  }
  var C = 0, q = 0;
  ...
  var t;
  if (r.symbol)
    t = new z("mo", [b0(r.name, r.mode)]), p1.has(r.name) && t.setAttribute("largeop", "false");
  else if (r.body)
...
var g1 = (r, e) => {
  var t, a, n = !1, l;
  r.type === "supsub" ? (t = r.sup, a = r.sub, l = H(r.base, "operatorname"), n = !0) : l = H(r, "operatorname");
  var u;
  if (l.body.length > 0) {
  ...
  for (var t = p0(r.body, e.withFont("mathrm")), a = !0, n = 0; n < t.length; n++) {
    var l = t[n];
    if (!(l instanceof Vr)) if (l instanceof z)
      switch (l.type) {
        case "mi":
        case "mn":
        case "mspace":
        ...
        case "mo": {
          var u = l.children[0];
          l.children.length === 1 && u instanceof _ ? u.text = u.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : a = !1;
          break;
        }
        default:
          a = !1;
...
B({
  ...
  htmlBuilder(r, e) {
    var t = U(r.body, e.havingCrampedStyle()), a = te("overline-line", e), n = e.fontMetrics().defaultRuleThickness, l = G({
      positionType: "firstBaseline",
      children: [{
        type: "elem",
        elem: t
...
B({
  ...
  handler(r, e, t) {
    var {
      parser: a
    } = r, n = t[0], l = H(e[0], "size"), u = H(e[1], "size");
    return {
      type: "rule",
      mode: a.mode,
...
B({
  ...
  handler: (r, e, t) => {
    var {
      parser: a
    } = r, n = !1, l = !1, u = t[0] && H(t[0], "ordgroup");
    if (u)
...
B({
  ...
  htmlBuilder(r, e) {
    ...
    var u = n + l / 4, h = t.height + t.depth + u + n, {
      span: c,
      ruleWidth: v,
      advanceWidth: g
    } = Xa(h, e), b = c.height - v;
    ...
    if (r.index) {
      var M = e.havingStyle(N.SCRIPTSCRIPT), T = U(r.index, M, e), C = 0.6 * (x.height - x.depth), q = G({
        positionType: "shift",
        positionData: -C,
        children: [{
          type: "elem",
...
B({
  ...
  handler(r, e) {
    var {
      ...
      funcName: a,
      parser: n
    } = r, l = n.parseExpression(!0, t), u = a.slice(1, a.length - 5);
    return {
      type: "styling",
      mode: n.mode,
...
$0({
  ...
  htmlBuilder(r, e) {
    ...
    var {
      ...
      sup: n,
      sub: l
    } = r, u = U(a, e), h, c, v = e.fontMetrics(), g = 0, b = 0, y = a && C0(a);
    if (n) {
    ...
    if (h && c) {
      ...
      g = Math.max(g, T, h.depth + 0.25 * v.xHeight), F = G({
        positionType: "shift",
        positionData: -g,
        children: [{
          type: "elem",
  ...
  htmlBuilder(r, e) {
    if (mt.hasOwnProperty(r.text)) {
      ...
      if (r.mode === "text") {
        ...
        return k(["mspace", t], [qt(r.text, r.mode, e)], e);
    } else {
...
var wr = {
  ...
  if (t) {
    ...
    if (kr[t])
      return e.withTextFontWeight(kr[t]);
    if (t === "\\emph")
...
B({
  ...
  htmlBuilder(r, e) {
    var t = U(r.body, e), a = te("underline-line", e), n = e.fontMetrics().defaultRuleThickness, l = G({
      positionType: "top",
      positionData: t.height,
      children: [{
        type: "kern",
...
var zr = (r) => r.body.replace(/ /g, r.star ? "␣" : " "), F0 = Pr, x1 = `[ \r
	]`, s4 = "\\\\[a-zA-Z@]+", u4 = "\\\\[^\uD800-\uDFFF]", o4 = "(" + s4 + ")" + x1 + "*", h4 = `\\\\(
|[ \r	]+
?)[ \r	]*`, Mt = "[̀-ͯ]", m4 = new RegExp(Mt + "+$"), c4 = "(" + x1 + "+)|" + // whitespace
(h4 + "|") + // \whitespace
"([!-\\[\\]-‧‪-퟿豈-￿]" + // single codepoint
(Mt + "*") + // ...plus accents
"|[\uD800-\uDBFF][\uDC00-\uDFFF]" + // surrogate pair
...
class Ar {
  ...
  lex() {
    ...
    if (t === e.length)
      return new d0("EOF", new c0(this, t, t));
...
var Lt = (r, e, t, a) => {
  ...
  if (!u && !t)
    throw new S("\\renewcommand{" + l + "} when command " + l + " does not yet exist; use \\newcommand");
  var h = 0;
...
var k1 = (r) => (e) => {
  ...
  var v = e.consumeArg().tokens, g = e.expandTokens([
    ...l,
    ...v,
    ...t
    // reversed
  ...
  consumeArgs(e, t) {
    if (t) {
      ...
      for (var a = t[0], n = 0; n < a.length; n++) {
        var l = this.popToken();
        if (a[n] !== l.text)
          throw new S("Use of the macro doesn't match its definition", l);
      }
    }
    for (var u = [], h = 0; h < e; h++)
    ...
    if (typeof n == "string") {
      ...
      if (n.includes("#"))
        for (var u = n.replace(/##/g, ""); u.includes("#" + (l + 1)); )
          ++l;
      for (var h = new Ar(n, this.settings), c = [], v = h.lex(); v.text !== "EOF"; )
        c.push(v), v = h.lex();
      c.reverse();
      var g = {
        tokens: c,
...
var Br = /^[₊₋₌₍₎₀₁₂₃₄₅₆₇₈₉ₐₑₕᵢⱼₖₗₘₙₒₚᵣₛₜᵤᵥₓᵦᵧᵨᵩᵪ]/, Be = Object.freeze({
  "₊": "+",
  "₋": "-",
  "₌": "=",
  "₍": "(",
...
class je {
  ...
  parseExpression(e, t) {
    for (var a = []; ; ) {
      ...
      var n = this.fetch();
      if (je.endOfExpression.has(n.text) || t && n.text === t || e && F0[n.text] && F0[n.text].infix)
        break;
  ...
  handleInfixNodes(e) {
    for (var t = -1, a, n = 0; n < e.length; n++) {
      ...
      if (l.type === "infix") {
        if (t !== -1)
          throw new S("only one infix operator per group", l.token);
        t = n, a = l.replaceWith;
      }
    }
    if (t !== -1 && a) {
    ...
    for (var a, n; ; ) {
      ...
      if (l.text === "\\limits" || l.text === "\\nolimits") {
        if (t && t.type === "op") {
          ...
          throw new S("Limit controls must follow a math operator", l);
        this.consume();
      } else if (l.text === "^") {
        if (a)
          throw new S("Double superscript", l);
        a = this.handleSupSubscript("superscript");
      } else if (l.text === "_") {
        if (n)
          throw new S("Double subscript", l);
  ...
  parseArguments(e, t) {
    ...
    for (var n = [], l = [], u = 0; u < a; u++) {
      ...
      t.type === "sqrt" && u === 1 && l[0] == null) && (h = "primitive");
  ...
  parseSizeGroup(e) {
    ...
    if (!qr(l))
      throw new S("Invalid unit: '" + l.unit + "'", t);
    return {
      type: "size",
      mode: this.mode,
      value: l,
  ...
  parseSymbol() {
    ...
    if (this.consume(), l)
      for (var b = 0; b < l[0].length; b++) {
        var y = l[0][b];
        if (!ct[y])
          throw new S("Unknown accent ' " + y + "'", e);
        var x = ct[y][this.mode] || ct[y].text;
        if (!x)
          throw new S("Accent " + y + " unsupported in " + this.mode + " mode", e);
        u = {
          type: "accent",
          mode: this.mode,
          loc: c0.range(e),
