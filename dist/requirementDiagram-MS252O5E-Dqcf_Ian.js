import { g as Ge } from "./chunk-55IACEB6-D_twcSMW.js";
import { s as Xe } from "./chunk-EDXVE4YY-DGDd9cTi.js";
import { _ as d, D as Be, b as Je, a as Ze, s as et, g as tt, p as st, q as it, c as Ne, l as qe, z as rt, C as nt, o as at, r as lt, u as ct } from "./index-DWbaqf43.js";
var Ce = function() {
  var e = /* @__PURE__ */ d(function($, i, n, l) {
    for (n = n || {}, l = $.length; l--; n[$[l]] = i) ;
    return n;
  }, "o"), r = [1, 3], u = [1, 4], h = [1, 5], o = [1, 6], c = [5, 6, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90], E = [1, 22], p = [2, 7], f = [1, 26], m = [1, 27], b = [1, 28], k = [1, 29], C = [1, 33], V = [1, 34], A = [1, 35], v = [1, 36], L = [1, 37], x = [1, 38], O = [1, 24], w = [1, 31], D = [1, 32], M = [1, 30], y = [1, 39], _ = [1, 40], g = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 77, 89, 90], P = [1, 61], X = [89, 90], Ve = [5, 8, 9, 11, 13, 21, 22, 23, 24, 27, 29, 41, 42, 43, 44, 45, 46, 54, 61, 63, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], Ee = [27, 29], Ae = [1, 70], ve = [1, 71], Le = [1, 72], xe = [1, 73], Oe = [1, 74], we = [1, 75], De = [1, 76], ee = [1, 83], U = [1, 80], te = [1, 84], se = [1, 85], ie = [1, 86], re = [1, 87], ne = [1, 88], ae = [1, 89], le = [1, 90], ce = [1, 91], oe = [1, 92], pe = [5, 8, 9, 11, 13, 21, 22, 23, 24, 27, 41, 42, 43, 44, 45, 46, 54, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], Y = [63, 64], Me = [1, 101], Fe = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 76, 77, 89, 90], N = [5, 8, 9, 11, 13, 21, 22, 23, 24, 41, 42, 43, 44, 45, 46, 54, 72, 74, 75, 76, 77, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89, 90], B = [1, 110], Q = [1, 106], H = [1, 107], K = [1, 108], W = [1, 109], j = [1, 111], he = [1, 116], ue = [1, 117], fe = [1, 114], me = [1, 115], Se = {
    ...
    performAction: /* @__PURE__ */ d(function(i, n, l, s, R, t, de) {
      var a = t.length - 1;
      switch (R) {
        case 4:
    ...
    parseError: /* @__PURE__ */ d(function(i, n) {
      if (n.recoverable)
        this.trace(i);
      else {
        var l = new Error(i);
    ...
    parse: /* @__PURE__ */ d(function(i) {
      var n = this, l = [0], s = [], R = [null], t = [], de = this.table, a = "", ge = 0, $e = 0, Ke = 2, Pe = 1, We = t.slice.call(arguments, 1), S = Object.create(this.lexer), z = { yy: {} };
      ...
      function Ue() {
        var T;
        return T = s.pop() || S.lex() || Pe, typeof T != "number" && (T instanceof Array && (s = T, T = s.pop()), T = n.symbols_[T] || T), T;
      }
      d(Ue, "lex");
      for (var I, G, q, Te, J = {}, ye, F, Ye, _e; ; ) {
        if (G = l[l.length - 1], this.defaultActions[G] ? q = this.defaultActions[G] : ((I === null || typeof I > "u") && (I = Ue()), q = de[G] && de[G][I]), typeof q > "u" || !q.length || !q[0]) {
          var ke = "";
          _e = [];
          for (ye in de[G])
            this.terminals_[ye] && ye > Ke && _e.push("'" + this.terminals_[ye] + "'");
          S.showPosition ? ke = "Parse error on line " + (ge + 1) + `:
` + S.showPosition() + `
Expecting ` + _e.join(", ") + ", got '" + (this.terminals_[I] || I) + "'" : ke = "Parse error on line " + (ge + 1) + ": Unexpected " + (I == Pe ? "end of input" : "'" + (this.terminals_[I] || I) + "'"), this.parseError(ke, {
            text: S.match,
        ...
        switch (q[0]) {
          case 1:
            l.push(I), R.push(S.yytext), t.push(S.yylloc), l.push(q[1]), I = null, $e = S.yyleng, a = S.yytext, ge = S.yylineno, Ie = S.yylloc;
            break;
          case 2:
            if (F = this.productions_[q[1]][1], J.$ = R[R.length - F], J._$ = {
              ...
              R,
              t
            ].concat(We)), typeof Te < "u")
              return Te;
            F && (l = l.slice(0, -1 * F * 2), R = R.slice(0, -1 * F), t = t.slice(0, -1 * F)), l.push(this.productions_[q[1]][0]), R.push(J.$), t.push(J._$), Ye = de[l[l.length - 2]][l[l.length - 1]], l.push(Ye);
            break;
          case 3:
            return !0;
        }
    ...
    var $ = {
      EOF: 1,
      parseError: /* @__PURE__ */ d(function(n, l) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ d(function(i, n) {
      ...
      unput: /* @__PURE__ */ d(function(i) {
        ...
        }, this.options.ranges && (this.yylloc.range = [R[0], R[0] + this.yyleng - n]), this.yyleng = this.yytext.length, this;
      }, "unput"),
...
` + n + "^";
      ...
      test_match: /* @__PURE__ */ d(function(i, n) {
        var l, s, R;
        ...
        }, this.options.ranges && (R.yylloc.range = this.yylloc.range.slice(0))), s = i[0].match(/(?:\r\n?|\n).*/g), s && (this.yylineno += s.length), this.yylloc = {
      ...
      next: /* @__PURE__ */ d(function() {
        ...
        for (var R = this._currentRules(), t = 0; t < R.length; t++)
          if (l = this._input.match(this.rules[R[t]]), l && (!n || l[0].length > n[0].length)) {
            if (n = l, s = t, this.options.backtrack_lexer) {
              if (i = this.test_match(l, R[t]), i !== !1)
                return i;
              if (this._backtrack) {
                n = !1;
                continue;
        ...
        return n ? (i = this.test_match(n, R[s]), i !== !1 ? i : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      topState: /* @__PURE__ */ d(function(n) {
        return n = this.conditionStack.length - 1 - Math.abs(n || 0), n >= 0 ? this.conditionStack[n] : "INITIAL";
      }, "topState"),
      // alias for begin(condition)
      pushState: /* @__PURE__ */ d(function(n) {
        this.begin(n);
      }, "pushState"),
      ...
      performAction: /* @__PURE__ */ d(function(n, l, s, R) {
        switch (s) {
          case 0:
            return "title";
          case 1:
...
var ot = Ce, Z, ht = (Z = class {
  constructor() {
    this.relations = [], this.latestRequirement = this.getInitialRequirement(), this.requirements = /* @__PURE__ */ new Map(), this.latestElement = this.getInitialElement(), this.elements = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.direction = "TB", this.RequirementType = {
      ...
      REFINES: "refines",
      TRACES: "traces"
    }, this.setAccTitle = Je, this.getAccTitle = Ze, this.setAccDescription = et, this.getAccDescription = tt, this.setDiagramTitle = st, this.getDiagramTitle = it, this.getConfig = /* @__PURE__ */ d(() => Ne().requirement, "getConfig"), this.clear(), this.setDirection = this.setDirection.bind(this), this.addRequirement = this.addRequirement.bind(this), this.setNewReqId = this.setNewReqId.bind(this), this.setNewReqRisk = this.setNewReqRisk.bind(this), this.setNewReqText = this.setNewReqText.bind(this), this.setNewReqVerifyMethod = this.setNewReqVerifyMethod.bind(this), this.addElement = this.addElement.bind(this), this.setNewElementType = this.setNewElementType.bind(this), this.setNewElementDocRef = this.setNewElementDocRef.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setCssStyle = this.setCssStyle.bind(this), this.setClass = this.setClass.bind(this), this.defineClass = this.defineClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
  }
  getDirection() {
  ...
  addElement(r) {
    return this.elements.has(r) || (this.elements.set(r, {
      ...
      cssStyles: [],
      classes: ["default"]
    }), qe.info("Added new element: ", r)), this.resetLatestElement(), this.elements.get(r);
  }
  getElements() {
  ...
  defineClass(r, u) {
    for (const h of r) {
      ...
      o === void 0 && (o = { id: h, styles: [], textStyles: [] }, this.classes.set(h, o)), u && u.forEach(function(c) {
        if (/color/.exec(c)) {
  ...
  getData() {
    ...
    for (const f of this.requirements.values()) {
      const m = f;
      m.id = f.name, m.cssStyles = f.cssStyles, m.cssClasses = f.classes.join(" "), m.shape = "requirementBox", m.look = r.look, m.colorIndex = u.length, u.push(m);
    }
    for (const f of this.elements.values()) {
      const m = f;
      m.shape = "requirementBox", m.look = r.look, m.id = f.name, m.cssStyles = f.cssStyles, m.cssClasses = f.classes.join(" "), m.colorIndex = u.length, u.push(m);
    }
    for (const f of this.relations) {
      let m = 0;
      const b = f.type === this.Relationships.CONTAINS, k = {
        id: `${f.src}-${f.dst}-${m}`,
        start: ((o = this.requirements.get(f.src)) == null ? void 0 : o.name) ?? ((c = this.elements.get(f.src)) == null ? void 0 : c.name),
        end: ((E = this.requirements.get(f.dst)) == null ? void 0 : E.name) ?? ((p = this.elements.get(f.dst)) == null ? void 0 : p.name),
        label: `&lt;&lt;${f.type}&gt;&gt;`,
...
}, d(Z, "RequirementDB"), Z), ut = /* @__PURE__ */ d((e) => {
  const r = Be(), { themeVariables: u, look: h } = r, { bkgColorArray: o, borderColorArray: c } = u;
  if (!(c != null && c.length))
    return "";
  let E = "";
  for (let p = 0; p < e.THEME_COLOR_LIMIT; p++)
    ...
    `;
  return E;
}, "genColor"), ft = /* @__PURE__ */ d((e) => {
  const r = Be(), { look: u, themeVariables: h } = r, { requirementEdgeLabelBackground: o } = h;
  return `
  ${ut(e)}
  marker {
...
var dt = /* @__PURE__ */ d(async function(e, r, u, h) {
  qe.info("REF0:"), qe.info("Drawing requirement diagram (unified)", r);
  const { securityLevel: o, state: c, layout: E, look: p } = Ne(), f = h.db.getData(), m = Ge(r, o);
  f.type = h.type, f.layoutAlgorithm = at(E), f.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) ?? 50, f.rankSpacing = (c == null ? void 0 : c.rankSpacing) ?? 50, f.markers = p === "neo" ? ["requirement_contains_neo", "requirement_arrow_neo"] : ["requirement_contains", "requirement_arrow"], f.diagramId = r, await lt(f, m);
  const b = 8;
  ct.insertTitle(
    m,
