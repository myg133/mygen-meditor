import { g as Ht } from "./chunk-FMBD7UC4-BcO4nba_.js";
import { _ as m, n as Mt, l as J, c as g1, o as Xt, r as Qt, u as rt, b as Jt, s as Zt, p as $t, a as te, g as ee, q as se, k as ie, t as re, J as ae, v as ne, x as st, d as it, y as ue, z as le, A as oe, B as ce } from "./index-DWbaqf43.js";
import { c as he } from "./chunk-YZCP3GAM-5B2TRNza.js";
import { g as de } from "./chunk-55IACEB6-D_twcSMW.js";
import { s as pe } from "./chunk-EDXVE4YY-DGDd9cTi.js";
import { c as fe } from "./channel-qLWyD7mH.js";
var ge = "flowchart-", w1, be = (w1 = class {
  // cspell:ignore funs
  constructor() {
    this.vertexCounter = 0, this.config = g1(), this.diagramId = "", this.vertices = /* @__PURE__ */ new Map(), this.edges = [], this.classes = /* @__PURE__ */ new Map(), this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.tooltips = /* @__PURE__ */ new Map(), this.subCount = 0, this.firstGraphFlag = !0, this.secCount = -1, this.posCrossRef = [], this.funs = [], this.setAccTitle = Jt, this.setAccDescription = Zt, this.setDiagramTitle = $t, this.getAccTitle = te, this.getAccDescription = ee, this.getDiagramTitle = se, this.funs.push(this.setupToolTips.bind(this)), this.addVertex = this.addVertex.bind(this), this.firstGraph = this.firstGraph.bind(this), this.setDirection = this.setDirection.bind(this), this.addSubGraph = this.addSubGraph.bind(this), this.addLink = this.addLink.bind(this), this.setLink = this.setLink.bind(this), this.updateLink = this.updateLink.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.destructLink = this.destructLink.bind(this), this.setClickEvent = this.setClickEvent.bind(this), this.setTooltip = this.setTooltip.bind(this), this.updateLinkInterpolate = this.updateLinkInterpolate.bind(this), this.setClickFun = this.setClickFun.bind(this), this.bindFunctions = this.bindFunctions.bind(this), this.lex = {
  ...
  lookUpDomId(i) {
    for (const n of this.vertices.values())
      if (n.id === i)
        return this.diagramId ? `${this.diagramId}-${n.domId}` : n.domId;
...
` + k + `
    ...
    if (A) {
      const f = r;
      (f == null ? void 0 : f.animate) !== void 0 && (A.animate = f.animate), (f == null ? void 0 : f.animation) !== void 0 && (A.animation = f.animation), (f == null ? void 0 : f.curve) !== void 0 && (A.interpolate = f.curve);
      return;
    }
    let y, b = this.vertices.get(i);
    if (b === void 0 && (n === void 0 && a === void 0 && u !== void 0 && u !== null && J.warn(
      ...
      styles: [],
      classes: []
    }, this.vertices.set(i, b)), this.vertexCounter++, n !== void 0 ? (this.config = g1(), y = this.sanitizeText(n.text.trim()), b.labelType = n.type, y.startsWith('"') && y.endsWith('"') && (y = y.substring(1, y.length - 1)), b.text = y) : b.text === void 0 && (b.text = i), a !== void 0 && (b.type = a), u != null && u.forEach((f) => {
      b.styles.push(f);
    }), o != null && o.forEach((f) => {
      b.classes.push(f);
    }), p !== void 0 && (b.dir = p), b.props === void 0 ? b.props = c : c !== void 0 && Object.assign(b.props, c), r !== void 0) {
      if (r.shape) {
      ...
      r != null && r.label && (b.text = r == null ? void 0 : r.label, b.labelType = this.sanitizeNodeLabelType(r == null ? void 0 : r.labelType)), r != null && r.icon && (b.icon = r == null ? void 0 : r.icon, !((K = r.label) != null && K.trim()) && b.text === i && (b.text = "")), r != null && r.form && (b.form = r == null ? void 0 : r.form), r != null && r.pos && (b.pos = r == null ? void 0 : r.pos), r != null && r.img && (b.img = r == null ? void 0 : r.img, !((E = r.label) != null && E.trim()) && b.text === i && (b.text = "")), r != null && r.constraint && (b.constraint = r.constraint), r.w && (b.assetWidth = Number(r.w)), r.h && (b.assetHeight = Number(r.h));
    }
  }
  /**
  ...
  addSingleLink(i, n, a, u) {
    ...
    const k = a.text;
    if (k !== void 0 && (c.text = this.sanitizeText(k.text.trim()), c.text.startsWith('"') && c.text.endsWith('"') && (c.text = c.text.substring(1, c.text.length - 1)), c.labelType = this.sanitizeNodeLabelType(k.type)), a !== void 0 && (c.type = a.type, c.stroke = a.stroke, c.length = a.length > 10 ? 10 : a.length), u && !this.edges.some((r) => r.id === u))
...
You have to call mermaid.initialize.`
  ...
  addLink(i, n, a) {
    ...
    for (const o of i)
      for (const p of n) {
        const c = o === i[i.length - 1], k = p === n[0];
  ...
  updateLink(i, n) {
    i.forEach((a) => {
      ...
      a === "default" ? this.edges.defaultStyle = n : (this.edges[a].style = n, (((o = (u = this.edges[a]) == null ? void 0 : u.style) == null ? void 0 : o.length) ?? 0) > 0 && !((c = (p = this.edges[a]) == null ? void 0 : p.style) != null && c.some((A) => A == null ? void 0 : A.startsWith("fill"))) && ((r = (k = this.edges[a]) == null ? void 0 : k.style) == null || r.push("fill:none")));
    });
  }
  addClass(i, n) {
    ...
    i.split(",").forEach((u) => {
      ...
      o === void 0 && (o = { id: u, styles: [], textStyles: [] }, this.classes.set(u, o)), a != null && a.forEach((p) => {
        if (/color/.exec(p)) {
  ...
  setClickFun(i, n, a) {
    if (g1().securityLevel !== "loose" || n === void 0)
      return;
    let u = [];
    if (typeof a == "string") {
      u = a.split(/,(?=(?:(?:[^"]*"){2})*[^"]*$)/);
    ...
    o && (o.haveCallback = !0, this.funs.push(() => {
      const p = this.lookUpDomId(i), c = document.querySelector(`[id="${p}"]`);
  ...
  setupToolTips(i) {
    const n = he();
    it(i).select("svg").selectAll("g.node").on("mouseover", (o) => {
      var r;
      const p = it(o.currentTarget), c = p.attr("title");
      if (c === null)
        return;
      const k = (r = o.currentTarget) == null ? void 0 : r.getBoundingClientRect();
      n.transition().duration(200).style("opacity", ".9"), n.text(p.attr("title")).style("left", window.scrollX + k.left + (k.right - k.left) / 2 + "px").style("top", window.scrollY + k.bottom + "px"), n.html(ue.sanitize(c)), p.classed("hover", !0);
    }).on("mouseout", (o) => {
   ...
   */
  clear(i = "gen-2") {
    this.vertices = /* @__PURE__ */ new Map(), this.classes = /* @__PURE__ */ new Map(), this.edges = [], this.funs = [this.setupToolTips.bind(this)], this.diagramId = "", this.subGraphs = [], this.subGraphLookup = /* @__PURE__ */ new Map(), this.subCount = 0, this.tooltips = /* @__PURE__ */ new Map(), this.firstGraphFlag = !0, this.version = i, this.config = g1(), le();
  }
  setGen(i) {
  ...
  addSubGraph(i, n, a) {
    let u = i.text.trim(), o = a.text;
    i === a && /\s/.exec(a.text) && (u = void 0);
    const c = (/* @__PURE__ */ m((b) => {
      const K = { boolean: {}, number: {}, string: {} }, E = [];
      let f;
      return { nodeList: b.filter(function(j) {
        const h1 = typeof j;
        return j.stmt && j.stmt === "dir" ? (f = j.value, !1) : j.trim() === "" ? !1 : h1 in K ? K[h1].hasOwnProperty(j) ? !1 : K[h1][j] = !0 : E.includes(j) ? !1 : E.push(j);
      }), dir: f };
    }, "uniq"))(n.flat()), k = c.nodeList;
    let r = c.dir;
    const A = g1().flowchart ?? {};
    if (r = r ?? (A.inheritDir ? this.getDirection() ?? g1().direction ?? void 0 : void 0), this.version === "gen-1")
      for (let b = 0; b < k.length; b++)
        k[b] = this.lookUpDomId(k[b]);
    ...
    return J.info("Adding", y.id, y.nodes, y.dir), y.nodes = this.makeUniq(y, this.subGraphs).nodes, this.subGraphs.push(y), this.subGraphLookup.set(u, y), u;
  }
  getPosForId(i) {
    for (const [n, a] of this.subGraphs.entries())
      if (a.id === i)
        return n;
    return -1;
  }
  ...
  destructEndLink(i) {
    const n = i.trim();
    let a = n.slice(0, -1), u = "arrow_open";
    switch (n.slice(-1)) {
      case "x":
  ...
  addNodeFromVertex(i, n, a, u, o, p) {
    var A;
    const c = a.get(i.id), k = u.get(i.id) ?? !1, r = this.findNode(n, i.id);
    if (r)
  ...
  getCompiledStyles(i) {
    ...
    for (const a of i) {
      ...
      u != null && u.styles && (n = [...n, ...u.styles ?? []].map((o) => o.trim())), u != null && u.textStyles && (n = [...n, ...u.textStyles ?? []].map((o) => o.trim()));
    }
    return n;
  }
  getData() {
    const i = g1(), n = [], a = [], u = this.getSubGraphs(), o = /* @__PURE__ */ new Map(), p = /* @__PURE__ */ new Map();
    ...
    return k.forEach((r, A) => {
      var f;
      const { arrowTypeStart: y, arrowTypeEnd: b } = this.destructEdgeType(r.type), K = [...k.defaultStyle ?? []];
      ...
      const E = {
        ...
        arrowTypeStart: (r == null ? void 0 : r.stroke) === "invisible" || (r == null ? void 0 : r.type) === "arrow_open" ? "none" : y,
...
}, m(w1, "FlowDB"), w1), Ae = /* @__PURE__ */ m(function(s, i) {
  return i.db.getClasses();
}, "getClasses"), ke = /* @__PURE__ */ m(async function(s, i, n, a) {
  var y;
  ...
  J.debug("Data: ", c);
  const k = de(i, u), r = a.db.getDirection();
  c.type = a.type, c.layoutAlgorithm = Xt(p), c.layoutAlgorithm === "dagre" && p === "elk" && J.warn(
    "flowchart-elk was moved to an external package in Mermaid v11. Please refer [release notes](https://github.com/mermaid-js/mermaid/releases/tag/v11.0.0) for more details. This diagram will be rendered using `dagre` layout as a fallback."
  ), c.direction = r, c.nodeSpacing = (o == null ? void 0 : o.nodeSpacing) || 50, c.rankSpacing = (o == null ? void 0 : o.rankSpacing) || 50, c.markers = ["point", "circle", "cross"], c.diagramId = i, J.debug("REF1:", c), await Qt(c, k);
  ...
  var s = /* @__PURE__ */ m(function(f1, h, d, g) {
    ...
    performAction: /* @__PURE__ */ m(function(h, d, g, l, _, t, G1) {
      var e = t.length - 1;
      switch (_) {
        case 2:
          this.$ = [];
    ...
    parse: /* @__PURE__ */ m(function(h) {
      var d = this, g = [0], l = [], _ = [null], t = [], G1 = this.table, e = "", v = 0, Nt = 0, Kt = 2, Gt = 1, jt = t.slice.call(arguments, 1), M = Object.create(this.lexer), A1 = { yy: {} };
      ...
      function Pt() {
        var X;
        return X = l.pop() || M.lex() || Gt, typeof X != "number" && (X instanceof Array && (l = X, X = l.pop()), X = d.symbols_[X] || X), X;
      }
      m(Pt, "lex");
      for (var Y, k1, Q, tt, R1 = {}, H1, c1, Ot, X1; ; ) {
        if (k1 = g[g.length - 1], this.defaultActions[k1] ? Q = this.defaultActions[k1] : ((Y === null || typeof Y > "u") && (Y = Pt()), Q = G1[k1] && G1[k1][Y]), typeof Q > "u" || !Q.length || !Q[0]) {
          var et = "";
          X1 = [];
          for (H1 in G1[k1])
            this.terminals_[H1] && H1 > Kt && X1.push("'" + this.terminals_[H1] + "'");
          M.showPosition ? et = "Parse error on line " + (v + 1) + `:
` + M.showPosition() + `
Expecting ` + X1.join(", ") + ", got '" + (this.terminals_[Y] || Y) + "'" : et = "Parse error on line " + (v + 1) + ": Unexpected " + (Y == Gt ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'"), this.parseError(et, {
            text: M.match,
        ...
        switch (Q[0]) {
          case 1:
            g.push(Y), _.push(M.yytext), t.push(M.yylloc), g.push(Q[1]), Y = null, Nt = M.yyleng, e = M.yytext, v = M.yylineno, $1 = M.yylloc;
            break;
          case 2:
            if (c1 = this.productions_[Q[1]][1], R1.$ = _[_.length - c1], R1._$ = {
            ...
            ]), tt = this.performAction.apply(R1, [
              e,
              Nt,
              v,
              A1.yy,
              ...
              return tt;
            c1 && (g = g.slice(0, -1 * c1 * 2), _ = _.slice(0, -1 * c1), t = t.slice(0, -1 * c1)), g.push(this.productions_[Q[1]][0]), _.push(R1.$), t.push(R1._$), Ot = G1[g[g.length - 2]][g[g.length - 1]], g.push(Ot);
            break;
          case 3:
            return !0;
        }
...
at.parser = at;
var Ut = at, zt = Object.assign({}, Ut);
zt.parse = (s) => {
  const i = s.replace(/}\s*\n/g, `}
`);
  return Ut.parse(i);
};
var Te = zt, Ce = /* @__PURE__ */ m((s, i) => {
  const n = fe, a = n(s, "r"), u = n(s, "g"), o = n(s, "b");
  return ce(a, u, o, i);
}, "fade"), De = /* @__PURE__ */ m((s) => `.label {
...
`, "getStyles"), Se = De, ve = {
  ...
  styles: Se,
  init: /* @__PURE__ */ m((s) => {
    s.flowchart || (s.flowchart = {}), s.layout && Mt({ layout: s.layout }), s.flowchart.arrowMarkerAbsolute = s.arrowMarkerAbsolute, Mt({ flowchart: { arrowMarkerAbsolute: s.arrowMarkerAbsolute } });
  }, "init")
};
export {
  ve as diagram
