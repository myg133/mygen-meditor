import { g as le } from "./chunk-55IACEB6-D_twcSMW.js";
import { s as he } from "./chunk-EDXVE4YY-DGDd9cTi.js";
import { _ as h, l as R, o as de, r as ge, D as ue, G as W, c as M, i as H, aF as pe, V as fe, W as me, X as ye } from "./index-DWbaqf43.js";
const _ = [];
for (let t = 0; t < 256; ++t)
...
var Q = function() {
  var t = /* @__PURE__ */ h(function(O, s, i, o) {
    for (i = i || {}, o = O.length; o--; i[O[o]] = s) ;
    return i;
  }, "o"), e = [1, 4], a = [1, 13], l = [1, 12], n = [1, 15], d = [1, 16], p = [1, 20], y = [1, 19], E = [6, 7, 8], k = [1, 26], L = [1, 24], N = [1, 25], b = [6, 7, 11], $ = [1, 6, 13, 15, 16, 19, 22], f = [1, 33], U = [1, 34], B = [1, 6, 7, 11, 13, 15, 16, 19, 22], X = {
    ...
    performAction: /* @__PURE__ */ h(function(s, i, o, c, u, r, P) {
      var g = r.length - 1;
      switch (u) {
        case 6:
        case 7:
        ...
        case 20:
          ...
          break;
        case 25:
          c.getLogger().trace("node found ..", r[g - 2]), this.$ = { id: r[g - 1], descr: r[g - 1], type: c.getType(r[g - 2], r[g]) };
          break;
        case 26:
          this.$ = { id: r[g], descr: r[g], type: c.nodeType.DEFAULT };
          break;
        case 27:
          c.getLogger().trace("node found ..", r[g - 3]), this.$ = { id: r[g - 3], descr: r[g - 1], type: c.getType(r[g - 2], r[g]) };
          break;
      }
    }, "anonymous"),
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: e }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: e }, { 6: a, 7: [1, 10], 9: 9, 12: 11, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y }, t(E, [2, 3]), { 1: [2, 2] }, t(E, [2, 4]), t(E, [2, 5]), { 1: [2, 6], 6: a, 12: 21, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y }, { 6: a, 9: 22, 12: 11, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y }, { 6: k, 7: L, 10: 23, 11: N }, t(b, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: p, 22: y }), t(b, [2, 18]), t(b, [2, 19]), t(b, [2, 20]), t(b, [2, 21]), t(b, [2, 23]), t(b, [2, 24]), t(b, [2, 26], { 19: [1, 30] }), { 20: [1, 31] }, { 6: k, 7: L, 10: 32, 11: N }, { 1: [2, 7], 6: a, 12: 21, 13: l, 14: 14, 15: n, 16: d, 17: 17, 18: 18, 19: p, 22: y }, t($, [2, 14], { 7: f, 11: U }), t(B, [2, 8]), t(B, [2, 9]), t(B, [2, 10]), t(b, [2, 15]), t(b, [2, 16]), t(b, [2, 17]), { 20: [1, 35] }, { 21: [1, 36] }, t($, [2, 13], { 7: f, 11: U }), t(B, [2, 11]), t(B, [2, 12]), { 21: [1, 37] }, t(b, [2, 25]), t(b, [2, 27])],
    ...
    parse: /* @__PURE__ */ h(function(s) {
      var i = this, o = [0], c = [], u = [null], r = [], P = this.table, g = "", F = 0, Z = 0, re = 2, ee = 1, oe = r.slice.call(arguments, 1), m = Object.create(this.lexer), I = { yy: {} };
      ...
      function te() {
        var x;
        return x = c.pop() || m.lex() || ee, typeof x != "number" && (x instanceof Array && (c = x, x = c.pop()), x = i.symbols_[x] || x), x;
      }
      h(te, "lex");
      for (var S, C, D, q, w = {}, G, v, ne, j; ; ) {
        if (C = o[o.length - 1], this.defaultActions[C] ? D = this.defaultActions[C] : ((S === null || typeof S > "u") && (S = te()), D = P[C] && P[C][S]), typeof D > "u" || !D.length || !D[0]) {
          var J = "";
          j = [];
          for (G in P[C])
            this.terminals_[G] && G > re && j.push("'" + this.terminals_[G] + "'");
          m.showPosition ? J = "Parse error on line " + (F + 1) + `:
` + m.showPosition() + `
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : J = "Parse error on line " + (F + 1) + ": Unexpected " + (S == ee ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(J, {
            text: m.match,
        ...
        switch (D[0]) {
          case 1:
            o.push(S), u.push(m.yytext), r.push(m.yylloc), o.push(D[1]), S = null, Z = m.yyleng, g = m.yytext, F = m.yylineno, Y = m.yylloc;
            break;
          case 2:
            if (v = this.productions_[D[1]][1], w.$ = u[u.length - v], w._$ = {
              ...
              u,
              r
            ].concat(oe)), typeof q < "u")
              return q;
            v && (o = o.slice(0, -1 * v * 2), u = u.slice(0, -1 * v), r = r.slice(0, -1 * v)), o.push(this.productions_[D[1]][0]), u.push(w.$), r.push(w._$), ne = P[o[o.length - 2]][o[o.length - 1]], o.push(ne);
            break;
          case 3:
            return !0;
        }
...
` + i + "^";
      ...
      test_match: /* @__PURE__ */ h(function(s, i) {
        ...
        }, this.options.ranges && (u.yylloc.range = this.yylloc.range.slice(0))), c = s[0].match(/(?:\r\n?|\n).*/g), c && (this.yylineno += c.length), this.yylloc = {
      ...
      next: /* @__PURE__ */ h(function() {
        ...
        for (var u = this._currentRules(), r = 0; r < u.length; r++)
          if (o = this._input.match(this.rules[u[r]]), o && (!i || o[0].length > i[0].length)) {
            if (i = o, c = r, this.options.backtrack_lexer) {
              if (s = this.test_match(o, u[r]), s !== !1)
                return s;
              if (this._backtrack) {
                i = !1;
                continue;
        ...
        return i ? (s = this.test_match(i, u[c]), s !== !1 ? s : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: /* @__PURE__ */ h(function(i, o, c, u) {
        switch (c) {
          case 0:
  ...
  return h(V, "Parser"), V.prototype = X, X.Parser = V, new V();
}();
Q.parser = Q;
var xe = Q, De = 12, T = {
  DEFAULT: 0,
  ...
  addNode(e, a, l, n) {
    ...
    if (k)
      k.children.push(E), this.nodes.push(E);
    else if (d)
      this.nodes.push(E);
    else
      throw new Error(
  ...
  decorateNode(e) {
    if (!e)
      return;
    const a = M(), l = this.nodes[this.nodes.length - 1];
   ...
   */
  getData() {
    const e = this.getMindmap(), a = M(), n = pe().layout !== void 0, d = a;
    ...
    const p = [], y = [];
    this.flattenNodes(e, p), this.generateEdges(e, y), R.debug(
...
}, h(A, "MindmapDB"), A), Le = /* @__PURE__ */ h(async (t, e, a, l) => {
  var b, $;
  R.debug(`Rendering mindmap diagram
` + t);
  const n = l.db, d = n.getData(), p = le(e, d.config.securityLevel);
  if (d.type = l.type, d.layoutAlgorithm = de(d.config.layout, {
    fallback: "cose-bilkent"
  }), d.diagramId = e, !n.getMindmap())
    return;
  d.nodes.forEach((f) => {
    f.shape === "rounded" ? (f.radius = 15, f.taper = 15, f.stroke = "none", f.width = 0, f.padding = 15) : f.shape === "circle" ? f.padding = 10 : f.shape === "rect" ? (f.width = 0, f.padding = 10) : f.shape === "hexagon" && (f.width = 0, f.height = 0);
  }), await ge(d, p);
  const { themeVariables: E } = ue(), { useGradient: k, gradientStart: L, gradientStop: N } = E;
  if (k && L && N) {
    const f = p.attr("id"), U = p.append("defs").append("linearGradient").attr("id", `${f}-gradient`).attr("gradientUnits", "objectBoundingBox").attr("x1", "0%").attr("y1", "0%").attr("x2", "100%").attr("y2", "0%");
    U.append("stop").attr("offset", "0%").attr("stop-color", L).attr("stop-opacity", 1), U.append("stop").attr("offset", "100%").attr("stop-color", N).attr("stop-opacity", 1);
  }
  he(
    p,
