import { _ as b, F as m, I as B, e as C, l as w, b as S, a as D, p as T, q as z, g as F, s as P, G as E, D as A, z as W } from "./index-DWbaqf43.js";
import { p as _ } from "./chunk-4BX2VUAB-Z2iPX9wy.js";
import { p as N } from "./wardley-RL74JXVD-DrWbK5uC.js";
var I = E.packet, u, v = (u = class {
  constructor() {
...
}, b(u, "PacketDB"), u), L = 1e4, M = /* @__PURE__ */ b((e, t) => {
  _(e, t);
  let s = -1, r = [], n = 1;
  ...
  for (let { start: a, end: i, bits: d, label: c } of e.blocks) {
    ...
    for (i ?? (i = a + (d ?? 1) - 1), d ?? (d = i - a + 1), s = i, w.debug(`Packet block ${a} - ${s} with label ${c}`); r.length <= l + 1 && t.getPacket().length < L; ) {
