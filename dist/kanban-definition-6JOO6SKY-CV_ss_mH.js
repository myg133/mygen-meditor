import { _ as c, l as te, c as W, I as fe, af as ye, ag as be, ah as me, Y as _e, G as K, i as F, t as ke, J as Ee, V as Se, W as le, X as ce } from "./index-DWbaqf43.js";
import { g as Ne } from "./chunk-FMBD7UC4-BcO4nba_.js";
var $ = function() {
  var t = /* @__PURE__ */ c(function(_, s, n, a) {
    ...
    parse: /* @__PURE__ */ c(function(s) {
      var n = this, a = [0], o = [], u = [null], e = [], B = this.table, l = "", z = 0, ie = 0, ue = 2, re = 1, ge = e.slice.call(arguments, 1), m = Object.create(this.lexer), T = { yy: {} };
      ...
      function ae() {
        var S;
        return S = o.pop() || m.lex() || re, typeof S != "number" && (S instanceof Array && (o = S, S = o.pop()), S = n.symbols_[S] || S), S;
      }
      c(ae, "lex");
      for (var E, R, v, Q, G = {}, X, I, oe, Y; ; ) {
        if (R = a[a.length - 1], this.defaultActions[R] ? v = this.defaultActions[R] : ((E === null || typeof E > "u") && (E = ae()), v = B[R] && B[R][E]), typeof v > "u" || !v.length || !v[0]) {
          ...
          m.showPosition ? Z = "Parse error on line " + (z + 1) + `:
` + m.showPosition() + `
Expecting ` + Y.join(", ") + ", got '" + (this.terminals_[E] || E) + "'" : Z = "Parse error on line " + (z + 1) + ": Unexpected " + (E == re ? "end of input" : "'" + (this.terminals_[E] || E) + "'"), this.parseError(Z, {
        ...
        switch (v[0]) {
          case 1:
            a.push(E), u.push(m.yytext), e.push(m.yylloc), a.push(v[1]), E = null, ie = m.yyleng, l = m.yytext, z = m.yylineno, q = m.yylloc;
            break;
          case 2:
...
` + t);
  ...
  for (const y of w) {
    ...
    N = N + 1, y.x = O * N + (N - 1) * i / 2, y.width = O, y.y = 0, y.height = O * 3, y.rx = 5, y.ry = 5, y.cssClasses = y.cssClasses + " section-" + N;
