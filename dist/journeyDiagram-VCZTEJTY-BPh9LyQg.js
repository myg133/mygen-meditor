import { g as gt } from "./chunk-FMBD7UC4-BcO4nba_.js";
import { a as mt, g as lt, h as xt, d as kt } from "./chunk-YZCP3GAM-5B2TRNza.js";
import { g as _t, s as vt, a as bt, b as wt, q as Tt, p as St, _ as s, c as R, d as G, e as $t, z as Mt } from "./index-DWbaqf43.js";
import { d as it } from "./arc-DViFEll7.js";
var U = function() {
...
` + _.showPosition() + `
Expecting ` + z.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : X = "Parse error on line " + (C + 1) + ": Unexpected " + (b == D ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(X, {
            text: _.match,
...
`, "getStyles"), jt = Bt, K = /* @__PURE__ */ s(function(t, e) {
  ...
  Z++;
  const p = 300 + 5 * 30;
  u.append("line").attr("id", f + "-task" + Z).attr("x1", i).attr("y1", e.y).attr("x2", i).attr("y2", p).attr("class", "task-line").attr("stroke-width", "1px").attr("stroke-dasharray", "4 2").attr("stroke", "#666"), Nt(u, {
    cx: i,
    cy: 300 + (5 - e.score) * 30,
    score: e.score
  });
...
var $ = R().journey, P = 0, Gt = /* @__PURE__ */ s(function(t, e, a, f) {
  ...
  }), ut(h), P = $.leftMargin + W, S.insert(0, 0, P, Object.keys(E).length * 50), Ht(h, r, 0, e);
  const d = S.getBounds();
...
}, H = $.sectionFills, st = $.sectionColours, Ht = /* @__PURE__ */ s(function(t, e, a, f) {
  const i = R().journey;
  let u = "";
  ...
  for (const [r, n] of e.entries()) {
    ...
    n.x = r * i.taskMargin + r * i.width + P, n.y = o, n.width = i.diagramMarginX, n.height = i.diagramMarginY, n.colour = x, n.fill = m, n.num = h, n.actors = l, j.drawTask(t, n, i, f), S.insert(n.x, n.y, n.x + n.width + i.taskMargin, 300 + 5 * 30);
  }
}, "drawTasks"), at = {
  setConf: Xt,
  draw: Gt
