import { g as Bt } from "./chunk-55IACEB6-D_twcSMW.js";
import { s as Ft } from "./chunk-EDXVE4YY-DGDd9cTi.js";
import { _ as p, b as Yt, a as Pt, s as zt, g as Gt, p as Kt, q as Ut, c as rt, l as V, z as Zt, x as jt, B as Wt, C as Qt, o as Xt, r as Ht, d as qt, u as Jt } from "./index-DWbaqf43.js";
import { c as $t } from "./channel-qLWyD7mH.js";
var gt = function() {
  var s = /* @__PURE__ */ p(function(I, n, a, l) {
    for (a = a || {}, l = I.length; l--; a[I[l]] = n) ;
    return a;
  }, "o"), i = [6, 8, 10, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 43, 44, 48, 50, 51, 52], o = [1, 10], h = [1, 11], c = [1, 12], u = [1, 13], f = [1, 23], d = [1, 24], k = [1, 25], W = [1, 26], Q = [1, 27], T = [1, 19], X = [1, 28], B = [1, 29], D = [1, 20], R = [1, 18], S = [1, 21], x = [1, 22], at = [1, 36], ct = [1, 37], ot = [1, 38], lt = [1, 39], ht = [1, 40], F = [6, 8, 10, 13, 15, 17, 20, 21, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 43, 44, 48, 50, 51, 52, 65, 66, 67, 68, 69], O = [1, 45], N = [1, 46], Y = [1, 55], P = [40, 48, 50, 51, 52, 70, 71], z = [1, 66], G = [1, 64], A = [1, 61], K = [1, 65], U = [1, 67], H = [6, 8, 10, 13, 17, 22, 24, 26, 28, 33, 34, 35, 36, 37, 40, 41, 42, 43, 44, 48, 49, 50, 51, 52, 65, 66, 67, 68, 69], bt = [65, 66, 67, 68, 69], mt = [1, 84], kt = [1, 83], Et = [1, 81], Tt = [1, 82], St = [6, 10, 42, 47], L = [6, 10, 13, 41, 42, 47, 48, 49], q = [1, 92], J = [1, 91], $ = [1, 90], Z = [19, 58], Ot = [1, 101], Nt = [1, 100], ut = [19, 58, 60, 62], dt = {
    ...
    performAction: /* @__PURE__ */ p(function(n, a, l, r, y, t, j) {
      var e = t.length - 1;
      switch (y) {
        case 1:
          break;
    ...
    parse: /* @__PURE__ */ p(function(n) {
      var a = this, l = [0], r = [], y = [null], t = [], j = this.table, e = "", et = 0, At = 0, Lt = 2, It = 1, wt = t.slice.call(arguments, 1), _ = Object.create(this.lexer), C = { yy: {} };
      ...
      function Rt() {
        var b;
        return b = r.pop() || _.lex() || It, typeof b != "number" && (b instanceof Array && (r = b, b = r.pop()), b = a.symbols_[b] || b), b;
      }
      p(Rt, "lex");
      for (var g, v, m, ft, w = {}, st, E, xt, it; ; ) {
        if (v = l[l.length - 1], this.defaultActions[v] ? m = this.defaultActions[v] : ((g === null || typeof g > "u") && (g = Rt()), m = j[v] && j[v][g]), typeof m > "u" || !m.length || !m[0]) {
          var _t = "";
          it = [];
          for (st in j[v])
...
` + _.showPosition() + `
Expecting ` + it.join(", ") + ", got '" + (this.terminals_[g] || g) + "'" : _t = "Parse error on line " + (et + 1) + ": Unexpected " + (g == It ? "end of input" : "'" + (this.terminals_[g] || g) + "'"), this.parseError(_t, {
            text: _.match,
        ...
        switch (m[0]) {
          case 1:
            l.push(g), y.push(_.yytext), t.push(_.yylloc), l.push(m[1]), g = null, At = _.yyleng, e = _.yytext, et = _.yylineno, yt = _.yylloc;
            break;
          case 2:
            if (E = this.productions_[m[1]][1], w.$ = y[y.length - E], w._$ = {
              ...
              y,
              t
            ].concat(wt)), typeof ft < "u")
              return ft;
            E && (l = l.slice(0, -1 * E * 2), y = y.slice(0, -1 * E), t = t.slice(0, -1 * E)), l.push(this.productions_[m[1]][0]), y.push(w.$), t.push(w._$), xt = j[l[l.length - 2]][l[l.length - 1]], l.push(xt);
            break;
          case 3:
            return !0;
        }
    ...
    var I = {
      EOF: 1,
      parseError: /* @__PURE__ */ p(function(a, l) {
        if (this.yy.parser)
      ...
      setInput: /* @__PURE__ */ p(function(n, a) {
      ...
      unput: /* @__PURE__ */ p(function(n) {
        ...
        return this.yylloc = {
          ...
          last_column: l ? (l.length === r.length ? this.yylloc.first_column : 0) + r[r.length - l.length].length - l[0].length : this.yylloc.first_column - a
...
` + a + "^";
      ...
      test_match: /* @__PURE__ */ p(function(n, a) {
        var l, r, y;
        ...
        }, this.options.ranges && (y.yylloc.range = this.yylloc.range.slice(0))), r = n[0].match(/(?:\r\n?|\n).*/g), r && (this.yylineno += r.length), this.yylloc = {
          first_line: this.yylloc.last_line,
          last_line: this.yylineno + 1,
          first_column: this.yylloc.last_column,
          last_column: r ? r[r.length - 1].length - r[r.length - 1].match(/\r?\n?/)[0].length : this.yylloc.last_column + n[0].length
        }, this.yytext += n[0], this.match += n[0], this.matches = n, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._backtrack = !1, this._input = this._input.slice(n[0].length), this.matched += n[0], l = this.performAction.call(this, this.yy, this, a, this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), l)
          return l;
        if (this._backtrack) {
          for (var t in y)
            this[t] = y[t];
      ...
      next: /* @__PURE__ */ p(function() {
        ...
        for (var y = this._currentRules(), t = 0; t < y.length; t++)
          if (l = this._input.match(this.rules[y[t]]), l && (!a || l[0].length > a[0].length)) {
            if (a = l, r = t, this.options.backtrack_lexer) {
              if (n = this.test_match(l, y[t]), n !== !1)
                return n;
              if (this._backtrack) {
                a = !1;
                continue;
        ...
        return a ? (n = this.test_match(a, y[r]), n !== !1 ? n : !1) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), {
          text: "",
          token: null,
          line: this.yylineno
      ...
      performAction: /* @__PURE__ */ p(function(a, l, r, y) {
        switch (r) {
          case 0:
...
var te = gt, M, ee = (M = class {
  constructor() {
    ...
    }, this.setAccTitle = Yt, this.getAccTitle = Pt, this.setAccDescription = zt, this.getAccDescription = Gt, this.setDiagramTitle = Kt, this.getDiagramTitle = Ut, this.getConfig = /* @__PURE__ */ p(() => rt().er, "getConfig"), this.clear(), this.addEntity = this.addEntity.bind(this), this.addAttributes = this.addAttributes.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setDirection = this.setDirection.bind(this), this.addCssStyles = this.addCssStyles.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
  }
  /**
   * Add entity
  ...
  addEntity(i, o = "") {
    var h;
    return this.entities.has(i) ? !((h = this.entities.get(i)) != null && h.alias) && o && (this.entities.get(i).alias = o, V.info(`Add alias '${o}' to entity '${i}'`)) : (this.entities.set(i, {
  ...
  addAttributes(i, o) {
    ...
    for (c = o.length - 1; c >= 0; c--)
      o[c].keys || (o[c].keys = []), o[c].comment || (o[c].comment = ""), h.attributes.push(o[c]), V.debug("Added attribute ", o[c].name);
  }
  /**
   * Add a relationship
   *
  ...
  addRelationship(i, o, h, c) {
    const u = this.entities.get(i), f = this.entities.get(h);
    if (!u || !f)
      return;
    const d = {
      entityA: u.id,
  ...
  getCompiledStyles(i) {
    ...
    for (const h of i) {
      ...
      c != null && c.styles && (o = [...o, ...c.styles ?? []].map((u) => u.trim())), c != null && c.textStyles && (o = [...o, ...c.textStyles ?? []].map((u) => u.trim()));
    }
    return o;
  }
  addCssStyles(i, o) {
  ...
  addClass(i, o) {
    i.forEach((h) => {
      ...
      c === void 0 && (c = { id: h, styles: [], textStyles: [] }, this.classes.set(h, c)), o && o.forEach(function(u) {
        if (/color/.exec(u)) {
  ...
  getData() {
    ...
    for (const f of this.entities.keys()) {
      ...
      d && (d.cssCompiledStyles = this.getCompiledStyles(d.cssClasses.split(" ")), d.colorIndex = c++, i.push(d));
    }
    let u = 0;
    for (const f of this.relationships) {
      const d = {
        id: jt(f.entityA, f.entityB, {
          prefix: "id",
          counter: u++
        }),
        type: "normal",
...
var se = /* @__PURE__ */ p(async function(s, i, o, h) {
  V.info("REF0:"), V.info("Drawing er diagram (unified)", i);
  const { securityLevel: c, er: u, layout: f } = rt(), d = h.db.getData(), k = Bt(i, c);
  d.type = h.type, d.layoutAlgorithm = Xt(f), d.config.flowchart.nodeSpacing = (u == null ? void 0 : u.nodeSpacing) || 140, d.config.flowchart.rankSpacing = (u == null ? void 0 : u.rankSpacing) || 80, d.direction = h.db.getDirection();
  const { config: W } = d, { look: Q } = W;
  Q === "neo" ? d.markers = [
    "only_one_neo",
    "zero_or_one_neo",
    "one_or_more_neo",
    "zero_or_more_neo"
  ] : d.markers = ["only_one", "zero_or_one", "one_or_more", "zero_or_more"], d.diagramId = i, await Ht(d, k), d.layoutAlgorithm === "elk" && k.select(".edges").lower();
  const T = k.selectAll('[id*="-background"]');
  Array.from(T).length > 0 && T.each(function() {
    const B = qt(this), R = B.attr("id").replace("-background", ""), S = k.select(`#${CSS.escape(R)}`);
    if (!S.empty()) {
...
}, "draw"), Ct = /* @__PURE__ */ p((s, i) => {
  const o = $t, h = o(s, "r"), c = o(s, "g"), u = o(s, "b");
  return Wt(h, c, u, i);
}, "fade"), nt = /* @__PURE__ */ new Set(["redux-color", "redux-dark-color"]), ie = /* @__PURE__ */ p((s) => {
